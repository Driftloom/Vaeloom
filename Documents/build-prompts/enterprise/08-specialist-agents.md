...
## Read first
`mvp/08-specialist-agents.md`. This phase completes the roster from MVP's seven (eight counting Memory Agent from file 04) to the full twenty-eight described in `Vaeloom-Complete-Documentation.md` §5.
