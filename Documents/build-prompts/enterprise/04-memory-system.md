# 04 â€” Memory System (Enterprise upgrade)
### Read first: `mvp/04-memory-system.md`. This is the highest-value upgrade in the whole enterprise folder â€” take the same care here you took in the MVP file.
...
- **Dedicated stores:** by this point `enterprise/02-database-schema.md` has already migrated the graph/vector layers â€” this file's extraction/retrieval code should be updated to target Neo4j/Qdrant directly rather than the MVP Postgres-extension versions.

## Out of scope
Cross-workspace or cross-tenant shared memory (not planned at all â€” memory is always individually owned, this is a hard product boundary, not a missing feature).
