=== SOVEREIGN PLAYBOOK: RESUME-OPTIMIZATION === Description: Claude 3.5/3.7
Sonnet playbook for precision ATS resume tailoring with prompt caching and
progressive UI card streaming. Security: ZERO CLOUD EGRESS (Local Air-Gapped
Inference)
