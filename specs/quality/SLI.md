...
> **Purpose:** Define Service Level Indicators for Vaeloom **Status:** 🆕 New
...
graph TD
 ...
 subgraph Indicators["SLI Indicators"]
 direction TB
 ...
 subgraph Reporting["SLI Reporting"]
...
> **Diagram:** SLI architecture — **6 indicators** (API availability/latency, AI
...
"good event" versus "total events" ratio — for example, API requests completing
in under 500 milliseconds versus all API requests — that feeds directly into SLO
...
document corresponds to a user-facing quality attribute — if the metric
