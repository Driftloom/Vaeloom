# Vaeloom MVP-to-Enterprise Continuation — Independent End-to-End Phase Prompt 04: Migration Program Planning, Waves, and Governance
...
Do **not** assume `CONT-P03` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.

### Predecessor identity
- **Previous phase:** `CONT-P03 — Delta Requirements, Compatibility, and Migration Contracts`
- **Current phase:** `CONT-P04 — Migration Program Planning, Waves, and Governance`
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `CONT-P03`. Re-run its full gate and generate a new handoff before resuming this file.
...
|---|---|---|---|---|---|---|---|
| PA-CONT-P04-001 | TO_BE_VERIFIED | TO_BE_VERIFIED | TO_BE_VERIFIED | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED | TO_BE_VERIFIED |
...
- Plan delivery as evidence-producing increments with feature flags, rollback points and kill switches.
- Include staffing resilience, ownership backups, budget guardrails, AI/provider spend budgets and support readiness.
- Use risk burn-down and decision-expiry reviews rather than static registers.
- Reserve capacity for remediation, accessibility, security, data quality and documentation—not only feature development.
...
# Enterprise Execution Prompt — CONT Phase 04: Migration Program Planning, Waves, and Governance
...
request:
  ...
  current_phase_id: CONT-P04
  current_phase_name: Migration Program Planning, Waves, and Governance
execution_rules:
...
## 1. Mission
Execute a controlled migration phase that will create a dependency-driven plan, governance, RACI, risk system, resource scenarios and phase gates. Preserve backward compatibility, provenance, user rights and rollback.
...
Program Manager; Product Manager; Engineering Manager; Release Manager; FinOps Specialist; Risk Owner.
...
- **Phase-specific rule:** Plan waves: foundation, shadow, staff, design partner, cohort, regions, GA, retirement.
...
- Governance/RACI/approvals
- Risk/issue/decision control
- Capacity/cost/schedule scenarios
...
| BQ-06 | What approved resource, date and procurement constraints apply? | Material boundary/acceptance | Structured decision with owner/date | Accountable owner | Blocks where unresolved |
...
|---|---|---|---|
| CONT-P04-R01 | Scope | Execute a controlled migration phase that will create a dependency-driven plan, governance, RACI, risk system, resource scenarios and phase gates. Preserve backward compatibility, provenance, user rights and rollback. | Approved objective/scope/owners/authority |
| CONT-P04-R02 | Evidence | Every material claim links to authoritative source or reproducible evidence. | No unsupported completion/security/compliance/scale claim |
| CONT-P04-R03 | Security/Privacy | Applicable security, privacy, abuse, rights and AI risks are designed, tested and owned. | No unresolved critical finding or expired waiver |
| CONT-P04-R04 | Quality | Validation covers normal, negative, boundary, failure and recovery. | Critical tests pass in representative environment |
| CONT-P04-R05 | Operations | Ownership, telemetry, support, rollback and lifecycle are included. | Runbook/rollback/telemetry evidence exists |
| CONT-P04-R06 | Data/AI | Data lineage, scope, quality, retention and AI lineage are explicit. | Source/version/owner/lifecycle reconstructable |
| CONT-P04-R07 | Traceability | Requirements map to design, artifacts, tests, evidence, risks and handoff. | No unexplained critical gap |
| CONT-P04-R08 | Gate | Progression is blocked until DoD and weighted gate pass. | Score ≥95 and zero mandatory blockers |
...
## 11. Workstreams
1. **WS-04.1: Delivery decomposition.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.
2. **WS-04.2: Dependency/critical path.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.
3. **WS-04.3: Governance/RACI/approvals.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.
4. **WS-04.4: Risk/issue/decision control.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.
5. **WS-04.5: Capacity/cost/schedule scenarios.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.

## 12. Detailed Tasks and Subtasks
1. Decompose outcomes into dependency-linked work packages.
2. Define entry/exit gates, evidence owners and exception expiry.
3. Create critical path and resource/budget/procurement scenarios without inventing values.
4. Establish RACI, review boards, change control and release authority.
5. Create risk burndown and assumption/decision calendars.
6. Plan waves: foundation, shadow, staff, design partner, cohort, regions, GA, retirement.
...
- Apply phase rule: Plan waves: foundation, shadow, staff, design partner, cohort, regions, GA, retirement.
...
Simulate dependencies and risks; verify owners, gates, evidence and rollback.
...
|---|---|---|---|---|---|---|---|
| EVD-CONT-P04-001 | Replace with real claim | CONT-P04-R01 | file/log/report/approval | TO_BE_VERIFIED | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED |
...
|---|---|---|---|---|---|---|
| RISK-CONT-P04-01 | Docs mistaken for runtime completion | Critical | False readiness | Require runtime evidence/status labels | Phase owner | OPEN |
| RISK-CONT-P04-02 | Scope/permission/data/compatibility assumed | High | Leak/loss/rework | Block or reversible validated decision | Product/Architecture/Security | OPEN |
| RISK-CONT-P04-03 | External API/model/standard changes | High | Regression | Pin versions, tests, owner, kill switch | Integration/AI | OPEN |
| RISK-CONT-P04-04 | Evidence incomplete | High | Untrustworthy gate | Immutable reports and baseline | QA/Release | OPEN |
| RISK-CONT-P04-05 | Old/new divergence | Critical | Data/permission harm | Reconciliation/pause/rollback | Migration | OPEN |
...
TRACK=CONT
PHASE=04
PHASE_NAME=Migration Program Planning, Waves, and Governance
