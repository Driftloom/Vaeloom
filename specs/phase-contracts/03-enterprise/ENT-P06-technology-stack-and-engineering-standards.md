...
Do **not** assume `ENT-P05` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `ENT-P05`. Re-run its full gate and generate a new handoff before resuming this file.
...
## 1. Mission
Select and pin technologies using compatibility, security, performance, cost, support and exit evidence.
...
- **Phase-specific rule:** Benchmark Kubernetes/Kafka/Neo4j/Qdrant/OpenSearch or alternatives before selection.
...
6. Benchmark Kubernetes/Kafka/Neo4j/Qdrant/OpenSearch or alternatives before selection.
...
- Apply phase rule: Benchmark Kubernetes/Kafka/Neo4j/Qdrant/OpenSearch or alternatives before selection.
