...
Do **not** assume `ENT-P16` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `ENT-P16`. Re-run its full gate and generate a new handoff before resuming this file.
...
- **Phase-specific rule:** Provide platform/cell/tenant safe telemetry, health scores, audit export and regional support.
...
6. Provide platform/cell/tenant safe telemetry, health scores, audit export and regional support.
...
- Apply phase rule: Provide platform/cell/tenant safe telemetry, health scores, audit export and regional support.
