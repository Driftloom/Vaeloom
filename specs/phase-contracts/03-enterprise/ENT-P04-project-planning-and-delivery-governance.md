...
Do **not** assume `ENT-P03` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `ENT-P03`. Re-run its full gate and generate a new handoff before resuming this file.
...
## 1. Mission
Create a dependency-driven plan, governance, RACI, risk system, resource scenarios and phase gates.
...
- **Phase-specific rule:** Govern editions, commitments, regions, plugins and agent lifecycle; block bespoke forks.
...
6. Govern editions, commitments, regions, plugins and agent lifecycle; block bespoke forks.
...
- Apply phase rule: Govern editions, commitments, regions, plugins and agent lifecycle; block bespoke forks.
...
- `DEL-ENT-P04-03` — RACI/approval matrix; versioned, owned, reviewed and linked.
- `DEL-ENT-P04-04` — risk/governance model; versioned, owned, reviewed and linked.
- `DEL-ENT-P04-05` — resource/cost scenarios; versioned, owned, reviewed and linked.
- Updated risk, decision, assumption, evidence, traceability and change registers.
- Gate report and next-phase handoff.
