...
Do **not** assume `MVP-P20` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
## 22. Deliverables
- `DEL-MVP-P20-01` — production validation; versioned, owned, reviewed and linked.
- `DEL-MVP-P20-02` — KPI/SLO/data/AI/security review; versioned, owned, reviewed and linked.
- `DEL-MVP-P20-03` — incident register; versioned, owned, reviewed and linked.
- `DEL-MVP-P20-04` — continue/rollback decision; versioned, owned, reviewed and linked.
- `DEL-MVP-P20-05` — stabilization backlog; versioned, owned, reviewed and linked.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `MVP-P20`. Re-run its full gate and generate a new handoff before resuming this file.
...
- **Phase-specific rule:** Prioritize memory correctness, trust, security and reliability over agent breadth.
...
6. Prioritize memory correctness, trust, security and reliability over agent breadth.
...
- Apply phase rule: Prioritize memory correctness, trust, security and reliability over agent breadth.
...
- `DEL-MVP-P21-02` — vulnerability/drift programs; versioned, owned, reviewed and linked.
- `DEL-MVP-P21-03` — cost/debt backlog; versioned, owned, reviewed and linked.
- `DEL-MVP-P21-04` — lifecycle/retirement plan; versioned, owned, reviewed and linked.
