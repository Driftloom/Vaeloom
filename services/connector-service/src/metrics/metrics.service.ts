...
export class MetricsService {
  ...
  constructor() {
    ...
    this.registry.setDefaultLabels({ service: 'connector-service' });
    collectDefaultMetrics({ register: this.registry, prefix: 'connector_service_' });

    this.httpRequests = new Counter({
      name: 'connector_service_http_requests_total',
    ...
    this.httpDuration = new Histogram({
      name: 'connector_service_http_request_duration_seconds',
    ...
    this.domainEvents = new Counter({
      name: 'connector_service_domain_events_total',
