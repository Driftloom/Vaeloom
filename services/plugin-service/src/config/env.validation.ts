...
export const envSchema = z.object({
  ...
  PORT: z.coerce.number().int().positive().default(3160),
  ...
  PLUGIN_SANDBOX_TIMEOUT: z.coerce.number().int().positive().default(5000),
  PLUGIN_CODE_MAX_BYTES: z.coerce.number().int().positive().default(102400),
  PLUGIN_STORE_DIR: z.string().default('plugins'),
});
