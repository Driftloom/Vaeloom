...
| 10.x Testing/QA           | DONE   | PARTIAL                 | 3640 pytest (security 233/233 170 unique; full suite serial passes), 41 jest across 8 suites, 9 Playwright e2e specs (gap vs 60 open); live PG RLS suite `test_rls_live_pg.py` 5/5 passes; coverage 94% + WCAG + perf tracked (EXC-P14-01..03, P15 owns)                                                                                                                                                 |
