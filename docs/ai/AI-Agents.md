...
monitoring agent health. The architecture supports 8 agents at MVP scale,
scaling to 28 agents at Enterprise scale, with strict isolation boundaries to
prevent agent interference.
...
- 8 specialized agents: Memory, Organization, Resume, Gmail, Job Search,
  Scheduler, Application, Reflection
