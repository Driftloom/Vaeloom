...
> **Purpose:** Provide the authoritative field-level data dictionary for every
> table and column in the Vaeloom database schema **Status:** 🆕 New **Owner:**
> Architecture Team **Version:** 1.0 **Last Updated:** 2026-07-16
> **Dependencies:** [`Schema.md`](./Schema.md),
> [`ER-Diagram.md`](./ER-Diagram.md), [`Indexes.md`](./Indexes.md),
> [`../Architecture/Data-Flow.md`](../Architecture/Data-Flow.md)
> **Implementation Status:** 📋 Spec Only

## Overview

A data dictionary is the authoritative reference for every table, column, type,
constraint, and relationship in the database. While [`Schema.md`](./Schema.md)
describes the schema at a design level and [`ER-Diagram.md`](./ER-Diagram.md)
shows relationships visually, this document is the field-by-field reference
engineers consult when writing queries, building migrations, or debugging data
issues. If a column is not in this dictionary, it should not be queried.
...
- All core tables (users, tenants, documents, memories, agents, connectors,
 audit)
- All enum types
...
### graph_nodes (Knowledge Graph — Apache AGE, provisioned in Docker, UNUSED in code)
...
> **Diagram:** Core table relationships. Every tenant-scoped table has
> `tenant_id` for RLS (not all shown).
...
- [`../Backend/Module-Specs.md`](../Backend/Module-Specs.md) — modules owning
 each table
