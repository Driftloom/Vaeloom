> **SUPERSEDED as governing baseline — kept for history only.** The governing
> MVP corrections/hardening spec is
> [`vaeloom-mvp-e2e-enterprise-hardened.md`](./vaeloom-mvp-e2e-enterprise-hardened.md)
> per `DOCUMENTATION-MAP.md:89` (INT-02 governs, this file is INT-03 reference).
