...
| --------- | ------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ---------------------- | ---------- |
| CF-P04-01 | Prompt §3 lists "Next.js, NestJS, FastAPI" architecture; repo has Next.js (`apps/web`) + FastAPI (`apps/backend`), no NestJS    | Repo truth outranks prose (carried CF-P03-02); roadmap/architecture phases target actual repo      | REPO > INT-05 > prompt | 2026-08-07 |
...
| CF-P04-03 | Prompt architecture lists "apps/core-api, apps/ai-service"; repo reality = `apps/web` + `apps/backend` (FastAPI monolith-style) | Planning targets `apps/backend` as the API/AI host; contracts split deferred to P07/P08            | REPO > prompt          | 2026-08-15 |
