...
| 4   | Backend test inventory                  | `Get-ChildItem apps/api/tests -Recurse -Filter test_*.py`                                                                                        | **130 test files** (unchanged) ✅                                                                                                                                                        |
...
| 6   | Backend source counts                   | `git ls-files 'apps/api/src/backend/**'` + disk scan                                                                                             | **217 committed .py / 220 on disk** (3 uncommitted: erasure/export/provenance services) ✅ corrected                                                                                     |
