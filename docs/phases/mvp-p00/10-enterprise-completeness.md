...
| 13  | Documentation        | APPLICABLE           | 498 .md, 20 ADRs, openapi.yaml 140.5 KB (143,910 B), 15 security docs, runbooks; docs maturity 93/100 (gap/completion reports — docs-only, never runtime evidence); 66-prompt pack 75/75 hash-verified                                                              | Technical Writer       | P18 (phase-linked docs; superseded cleanup)                        |
...
| 18  | Migration and change | APPLICABLE           | Alembic migrations 0001–0007 in place; no legacy data migration in MVP; production migration/rollback **not proven** (no deploy — BQ-02); change register live (CHG-P00-01/02 in 05); scope-change discipline documented; gate authority = USER (BQ-01)             | Platform / Phase owner | P19 (deploy + rollback drill); every phase gate; P04 governance    |

## Summary

- **APPLICABLE:** 9 (business/product, architecture, data, security, privacy,
  quality, documentation, responsible AI, migration and change)
