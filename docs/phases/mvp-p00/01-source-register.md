...
| INT-02 | vaeloom-mvp-e2e-enterprise-hardened.md                            | **CANONICAL — GOVERNING for MVP (user-supplied)**                                                                                                                                                                                                                                                                                      | Vaeloom source team | 2026-08-06 (user provided; SHA-256 verified `2FA8966F…69640`, 91,469 bytes) | `docs/vaeloom-mvp-e2e-enterprise-hardened.md` (placed in repo 2026-08-11) — authenticity confirmed                                                              |
| INT-03 | vaeloom-mvp-e2e.md                                                | CANONICAL (MVP baseline, subordinate to INT-02)                                                                                                                                                                                                                                                                                        | Vaeloom source team | 2026-08-06                                                                  | `docs/vaeloom-mvp-e2e.md` SHA256 `AD8550F5…AFBF` (placed in repo 2026-08-11)                                                                                    |
| INT-04 | vaeloom-enterprise-e2e.md                                         | CANONICAL (enterprise baseline — reference only for MVP)                                                                                                                                                                                                                                                                               | Vaeloom source team | 2026-08-06                                                                  | `docs/vaeloom-enterprise-e2e.md` SHA256 `C9021F33…A825` (placed in repo 2026-08-11)                                                                             |
...
| INT-12 | 66-prompt pack manifest + master index + SHA256SUMS               | CANONICAL (prompt set integrity)                                                                                                                                                                                                                                                                                                       | 66-prompt pack      | 2026-08-06                                                                  | `docs/prompts/vaeloom-66-independent-end-to-end-phase-prompts/` (76 files, SHA256-verified 2026-08-11 vs `SHA256SUMS.md`; + live `EXECUTION-STATUS.md` overlay) |
