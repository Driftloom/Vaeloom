...
graph TD
 ...
 %% ─── Execution Phase ───
 subgraph Execute["2. Execution Phase"]
 direction TB
...
> _Last verified: 2026-09-15 — scheduling unchanged; job CRUD also exposed via
> `/api/v1/scheduler/jobs` (see API-Reference.md)._
