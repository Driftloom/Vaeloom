...
calls), and the communication pattern (direct call, event, or shared kernel).
Clear module boundaries prevent coupling, enable independent testing, and allow
...
graph TD
    ...
    subgraph SHARED["Shared Kernel"]
        TYPES["Shared Types<br/>(Pydantic models)"]:::shared
...
> **Diagram:** Module dependency graph. Arrows show dependencies (direct call =
