...
- Resume agent handler.py
- Templates in services/resume_templates.py (5 industry templates)
- PDF compilation via Playwright Chromium (page.pdf())
- DOCX via python-docx
- Jinja2 HTML templates under templates/resumes/
- Tailoring to job descriptions
- ATS optimization
- resume_artifacts table (migration 0023)
