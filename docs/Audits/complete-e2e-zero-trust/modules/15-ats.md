...
- ATS agent with semantic scoring
- calculate_semantic_ats_score tool
- extract_missing_hard_skills tool
- audit_ats_formatting tool
- Cosine similarity + keyword gazetteer fallback
- Score consistency and reproducibility testing
