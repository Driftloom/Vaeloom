# Module 05: Workspace & File Management
...
- Document upload/download/preview via DocumentService
- XMLHttpRequest upload with progress tracking
- Folder navigation, metadata, search, filtering
- Bulk operations, version detection
- Files page at workspace/[workspaceId]/files
