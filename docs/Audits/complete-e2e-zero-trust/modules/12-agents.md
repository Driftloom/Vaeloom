...
- 24 agents total. For each include: name, handler file, tools, autonomy, memory
  access, approval gates
- Key agents: resume, ats, career, memory, organization, job_search,
  application, gmail, scheduler, drive, github, analytics, coding, connector,
  learning, plugin, qa, recommendation, reflection, reminder, research, security
