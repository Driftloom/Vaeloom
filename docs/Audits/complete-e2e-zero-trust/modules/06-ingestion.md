...
- Document upload → parsing → extraction → memory → search indexing
- PDF/DOCX support via Playwright Chromium
- Document chunks model for chunked storage
- Memory extraction from documents
- Deduplication and version detection
