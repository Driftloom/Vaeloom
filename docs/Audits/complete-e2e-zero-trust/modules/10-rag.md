# Module 10: Vector Search & Hybrid RAG
...
- Three concurrent search strategies: vector (cosine), keyword (ILIKE), graph
  traversal
- Deduplication and overlap removal
- Relevance scoring
- DEFAULT_MAX_CONTEXT_TOKENS = 8000
- ContextEngine for filtering, ranking, compression, validation
