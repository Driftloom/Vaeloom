# E2E Scenario: 014-delete-everything.md

## Scenario Description and Goal

Delete workspace → verify: DB records gone, graph nodes gone, vector embeddings
gone, object storage cleaned, cache invalidated, search index cleared, audit
trail preserved
