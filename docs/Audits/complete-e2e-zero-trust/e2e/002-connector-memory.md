# E2E Scenario: 002-connector-memory.md

## Scenario Description and Goal

Connect Google Drive → sync documents → ingest → extract entities → knowledge
graph populated → vector embeddings created → search returns results
