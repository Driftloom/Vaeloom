# E2E Scenario: 008-application.md

## Scenario Description and Goal

Select job → fit analysis → tailor resume → generate cover letter → review →
approve → submit application → career memory updated → status tracking
