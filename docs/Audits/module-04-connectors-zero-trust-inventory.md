...
## 6. Frontend Architecture & Capabilities Integration

In compliance with enterprise single-pane-of-glass UX principles and user
directives, the Connectors subsystem is unified under the **Capabilities
Workbench**:

| Component / Artifact         | File Path                                                                                                                                                                           | Architectural Role & Implementation Details                                                                                                                                                                                                                                                                                                                                  |
| :--------------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Connectors Studio**        | [`apps/web/src/components/capabilities/ConnectorsView.tsx`](file:///c:/PROJECTS/PIOS/ClonU/Driftloom/Vaeloom/apps/web/src/components/capabilities/ConnectorsView.tsx)               | Authoritative unified UI. Pixel-matched Claude Customize Connectors interface with `Yours` (configured workspace connectors) vs `Discover` (catalog directory) sub-navigation, real-time search, category dropdown (`Filter: All`), Top 14 connectors with `• 260+ available` and `Show all (269)`, Trending connectors with badges, and New connectors with `Desktop` tags. |
| **Authoritative Catalog**    | [`apps/web/src/lib/connectors-catalog.ts`](file:///c:/PROJECTS/PIOS/ClonU/Driftloom/Vaeloom/apps/web/src/lib/connectors-catalog.ts)                                                 | Centralized catalog definition of 260+ enterprise connectors (Top 14, Trending 6, New 4, and 240+ Composio SaaS integrations), complete with high-fidelity brand SVG icons, zero-trust scopes, and assigned agent mappings.                                                                                                                                                  |
| **Navigation Consolidation** | [`apps/web/src/components/layout/Sidebar.tsx`](file:///c:/PROJECTS/PIOS/ClonU/Driftloom/Vaeloom/apps/web/src/components/layout/Sidebar.tsx)                                         | Eliminated redundant standalone "Connectors" sidebar link. Connectors are accessed canonically via `/workspace/[id]/capabilities?category=connectors`.                                                                                                                                                                                                                       |
| **Transparent Redirection**  | [`apps/web/src/app/workspace/[workspaceId]/connectors/page.tsx`](file:///c:/PROJECTS/PIOS/ClonU/Driftloom/Vaeloom/apps/web/src/app/workspace/%5BworkspaceId%5D/connectors/page.tsx) | Automatic Next.js client redirect ensuring any legacy bookmarks or deep links seamlessly route to the unified capabilities workbench.                                                                                                                                                                                                                                        |
