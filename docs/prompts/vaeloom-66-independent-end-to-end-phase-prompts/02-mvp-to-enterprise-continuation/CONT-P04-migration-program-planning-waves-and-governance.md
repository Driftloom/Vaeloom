...
Do **not** assume `CONT-P03` passed because a document says “complete.” Re-audit
...
`CONT-P03`. Re-run its full gate and generate a new handoff before resuming this
file.
...
> NOT_EXECUTED **Phase type:** `PLANNING` **Phase ID:** `CONT-P04`
...
Execute a controlled migration phase that will create a dependency-driven plan,
governance, RACI, risk system, resource scenarios and phase gates. Preserve
...
- **Out of scope:** Big-bang rewrite, silent permission expansion, unverified
  ...
  evidence.
- **Phase-specific rule:** Plan waves: foundation, shadow, staff, design
  partner, cohort, regions, GA, retirement.
...
6. Plan waves: foundation, shadow, staff, design partner, cohort, regions, GA,
   retirement.
...
- Preserve approved architecture: Strangler/expand-contract path with
  ...
  explicit retirement.
- Apply phase rule: Plan waves: foundation, shadow, staff, design partner,
  cohort, regions, GA, retirement.
...
Prepare for **Target Architecture and Evolution ADRs**: approved
