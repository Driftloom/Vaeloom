...
Do **not** assume `CONT-P06` passed because a document says “complete.” Re-audit
its actual artifacts and evidence before executing this phase.

### Predecessor identity

- **Previous phase:**
  `CONT-P06 — Platform, Toolchain, and Engineering-Standard Evolution`
...
- `DEL-CONT-P06-01` — technology decision matrix; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P06-02` — version policy; versioned, owned, reviewed and linked.
- `DEL-CONT-P06-03` — engineering standards; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P06-04` — dependency governance; versioned, owned, reviewed and
  linked.
...
`CONT-P06`. Re-run its full gate and generate a new handoff before resuming this
file.
...
> NOT_EXECUTED **Phase type:** `DATA_DESIGN` **Phase ID:** `CONT-P07`
...
Execute a controlled migration phase that will design authoritative data
ownership, isolation, provenance, lifecycle, migration, backup, deletion and
query strategy. Preserve backward compatibility, provenance, user rights and
rollback.
...
- **Out of scope:** Big-bang rewrite, silent permission expansion, unverified
  ...
  evidence.
- **Phase-specific rule:** Record source/target IDs, mapping version,
  checksum/count, result and rollback; never infer.
...
- Preserve approved architecture: Strangler/expand-contract path with
  ...
  explicit retirement.
- Apply phase rule: Record source/target IDs, mapping version, checksum/count,
  result and rollback; never infer.
...
- `DEL-CONT-P07-01` — data models/dictionary; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P07-02` — migration/rollback plan; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P07-03` — isolation rules; versioned, owned, reviewed and linked.
- `DEL-CONT-P07-04` — provenance/lifecycle/deletion; versioned, owned, reviewed
  and linked.
- `DEL-CONT-P07-05` — backup/query evidence; versioned, owned, reviewed and
  linked.
- Updated risk, decision, assumption, evidence, traceability and change
  registers.
- Gate report and next-phase handoff.
...
Prepare for **API, Event, Connector, and Contract Compatibility**: approved
