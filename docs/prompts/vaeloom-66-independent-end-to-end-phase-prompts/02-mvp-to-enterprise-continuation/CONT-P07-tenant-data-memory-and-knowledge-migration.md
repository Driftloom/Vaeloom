# Vaeloom MVP-to-Enterprise Continuation — Independent End-to-End Phase Prompt 07: Tenant, Data, Memory, and Knowledge Migration
...
Do **not** assume `CONT-P06` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.

### Predecessor identity
- **Previous phase:** `CONT-P06 — Platform, Toolchain, and Engineering-Standard Evolution`
- **Current phase:** `CONT-P07 — Tenant, Data, Memory, and Knowledge Migration`
...
## 22. Deliverables
- `DEL-CONT-P06-01` — technology decision matrix; versioned, owned, reviewed and linked.
- `DEL-CONT-P06-02` — version policy; versioned, owned, reviewed and linked.
- `DEL-CONT-P06-03` — engineering standards; versioned, owned, reviewed and linked.
- `DEL-CONT-P06-04` — dependency governance; versioned, owned, reviewed and linked.
- `DEL-CONT-P06-05` — cost/exit strategy; versioned, owned, reviewed and linked.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `CONT-P06`. Re-run its full gate and generate a new handoff before resuming this file.
...
|---|---|---|---|---|---|---|---|
| PA-CONT-P07-001 | TO_BE_VERIFIED | TO_BE_VERIFIED | TO_BE_VERIFIED | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED | TO_BE_VERIFIED |
...
- Version schemas, embeddings, chunking, graph projections and lineage so reprocessing can occur without destructive overwrite.
- Design deletion as a cross-store workflow with primary completion, backup expiry, legal hold and user receipts.
- Create reconciliation, projection rebuild, restore and point-in-time recovery tests before scale.
- Use synthetic or consented test data with classification and residency controls.
...
# Enterprise Execution Prompt — CONT Phase 07: Tenant, Data, Memory, and Knowledge Migration
...
> **Phase type:** `DATA_DESIGN`
> **Phase ID:** `CONT-P07`

```yaml
request:
  mode: GENERATE_AND_EXECUTE_PHASE
  current_phase_id: CONT-P07
  current_phase_name: Tenant, Data, Memory, and Knowledge Migration
execution_rules:
...
## 1. Mission
Execute a controlled migration phase that will design authoritative data ownership, isolation, provenance, lifecycle, migration, backup, deletion and query strategy. Preserve backward compatibility, provenance, user rights and rollback.
...
Data Architect; Database Engineer; Privacy Engineer; Security Architect; Data Engineer; SRE; QA Lead.
...
- **Phase-specific rule:** Record source/target IDs, mapping version, checksum/count, result and rollback; never infer.
...
| BQ-06 | Who owns data and what classification/retention/residency/RPO/RTO apply? | Material boundary/acceptance | Structured decision with owner/date | Accountable owner | Blocks where unresolved |
...
|---|---|---|---|
| CONT-P07-R01 | Scope | Execute a controlled migration phase that will design authoritative data ownership, isolation, provenance, lifecycle, migration, backup, deletion and query strategy. Preserve backward compatibility, provenance, user rights and rollback. | Approved objective/scope/owners/authority |
| CONT-P07-R02 | Evidence | Every material claim links to authoritative source or reproducible evidence. | No unsupported completion/security/compliance/scale claim |
| CONT-P07-R03 | Security/Privacy | Applicable security, privacy, abuse, rights and AI risks are designed, tested and owned. | No unresolved critical finding or expired waiver |
| CONT-P07-R04 | Quality | Validation covers normal, negative, boundary, failure and recovery. | Critical tests pass in representative environment |
| CONT-P07-R05 | Operations | Ownership, telemetry, support, rollback and lifecycle are included. | Runbook/rollback/telemetry evidence exists |
| CONT-P07-R06 | Data/AI | Data lineage, scope, quality, retention and AI lineage are explicit. | Source/version/owner/lifecycle reconstructable |
| CONT-P07-R07 | Traceability | Requirements map to design, artifacts, tests, evidence, risks and handoff. | No unexplained critical gap |
| CONT-P07-R08 | Gate | Progression is blocked until DoD and weighted gate pass. | Score ≥95 and zero mandatory blockers |
...
## 11. Workstreams
1. **WS-07.1: Conceptual/logical/physical model.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.
2. **WS-07.2: Isolation/authorization invariants.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.
3. **WS-07.3: Provenance/lifecycle/rights.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.
4. **WS-07.4: Migration/backup/recovery.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.
5. **WS-07.5: Indexes/query/capacity.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.

## 12. Detailed Tasks and Subtasks
1. Define entities, identifiers, ownership, sensitivity, provenance and lifecycle.
2. Select authoritative stores and label projections.
3. Enforce scope keys through constraints/policies so missing filters cannot leak.
4. Design safe idempotent observable forward/backward migrations.
5. Design correction, supersession, export, deletion, backup expiry and legal hold.
6. Benchmark queries/writes and define indexes/partition/capacity triggers.
7. Record source/target IDs, mapping version, checksum/count, result and rollback; never infer.
...
- Apply phase rule: Record source/target IDs, mapping version, checksum/count, result and rollback; never infer.
...
Run schema/migration/isolation/property/backup/deletion/reconciliation/query tests.
...
## 22. Deliverables
- `DEL-CONT-P07-01` — data models/dictionary; versioned, owned, reviewed and linked.
- `DEL-CONT-P07-02` — migration/rollback plan; versioned, owned, reviewed and linked.
- `DEL-CONT-P07-03` — isolation rules; versioned, owned, reviewed and linked.
- `DEL-CONT-P07-04` — provenance/lifecycle/deletion; versioned, owned, reviewed and linked.
- `DEL-CONT-P07-05` — backup/query evidence; versioned, owned, reviewed and linked.
- Updated risk, decision, assumption, evidence, traceability and change registers.
- Gate report and next-phase handoff.
...
|---|---|---|---|---|---|---|---|
| EVD-CONT-P07-001 | Replace with real claim | CONT-P07-R01 | file/log/report/approval | TO_BE_VERIFIED | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED |
...
| RISK-CONT-P07-02 | Scope/permission/data/compatibility assumed | High | Leak/loss/rework | Block or reversible validated decision | Product/Architecture/Security | OPEN |
| RISK-CONT-P07-03 | External API/model/standard changes | High | Regression | Pin versions, tests, owner, kill switch | Integration/AI | OPEN |
| RISK-CONT-P07-04 | Evidence incomplete | High | Untrustworthy gate | Immutable reports and baseline | QA/Release | OPEN |
| RISK-CONT-P07-05 | Old/new divergence | Critical | Data/permission harm | Reconciliation/pause/rollback | Migration | OPEN |
...
TRACK=CONT
PHASE=07
PHASE_NAME=Tenant, Data, Memory, and Knowledge Migration
