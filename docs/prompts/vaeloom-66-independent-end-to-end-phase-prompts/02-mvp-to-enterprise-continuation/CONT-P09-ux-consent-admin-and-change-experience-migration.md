...
Do **not** assume `CONT-P08` passed because a document says “complete.” Re-audit
...
`CONT-P08`. Re-run its full gate and generate a new handoff before resuming this
file.
...
> NOT_EXECUTED **Phase type:** `UX_DESIGN` **Phase ID:** `CONT-P09`
...
Execute a controlled migration phase that will design accessible journeys, trust
and approval states, failure recovery, design-system governance and usability
evidence. Preserve backward compatibility, provenance, user rights and rollback.
...
- **Out of scope:** Big-bang rewrite, silent permission expansion, unverified
  ...
  evidence.
- **Phase-specific rule:** Distinguish personal/institution contexts and make
  purpose/visibility understandable.
...
6. Distinguish personal/institution contexts and make purpose/visibility
   understandable.
...
- Preserve approved architecture: Strangler/expand-contract path with
  ...
  explicit retirement.
- Apply phase rule: Distinguish personal/institution contexts and make
  purpose/visibility understandable.
...
Prepare for **Frontend Coexistence and Progressive Migration**: approved
