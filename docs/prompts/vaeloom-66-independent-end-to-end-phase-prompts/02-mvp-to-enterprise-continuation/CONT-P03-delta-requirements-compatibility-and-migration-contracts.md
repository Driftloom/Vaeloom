...
Do **not** assume `CONT-P02` passed because a document says “complete.” Re-audit
...
- `DEL-CONT-P02-01` — research plan/repository; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P02-02` — domain/competitor analysis; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P02-03` — data/source feasibility; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P02-04` — regulatory applicability; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P02-05` — decision implications; versioned, owned, reviewed and
  linked.
...
`CONT-P02`. Re-run its full gate and generate a new handoff before resuming this
file.
...
> NOT_EXECUTED **Phase type:** `REQUIREMENTS` **Phase ID:** `CONT-P03`
...
Execute a controlled migration phase that will convert validated needs into
atomic, testable, traceable functional and non-functional requirements. Preserve
backward compatibility, provenance, user rights and rollback.
...
- **Out of scope:** Big-bang rewrite, silent permission expansion, unverified
  ...
  evidence.
- **Phase-specific rule:** Catalog invariants: ownership, provenance, approvals,
  rights, IDs, audit and API behavior.
...
5. Map source→design→implementation→test→evidence→owner→gate and approve
   baseline.
6. Catalog invariants: ownership, provenance, approvals, rights, IDs, audit and
   API behavior.
...
- Preserve approved architecture: Strangler/expand-contract path with
  ...
  explicit retirement.
- Apply phase rule: Catalog invariants: ownership, provenance, approvals,
  rights, IDs, audit and API behavior.
...
- `DEL-CONT-P03-01` — versioned requirements; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P03-02` — stories/acceptance; versioned, owned, reviewed and linked.
- `DEL-CONT-P03-03` — traceability matrix; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P03-04` — priority/release baseline; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P03-05` — change-control rules; versioned, owned, reviewed and
  linked.
- Updated risk, decision, assumption, evidence, traceability and change
  registers.
- Gate report and next-phase handoff.
...
Prepare for **Migration Program Planning, Waves, and Governance**: approved
