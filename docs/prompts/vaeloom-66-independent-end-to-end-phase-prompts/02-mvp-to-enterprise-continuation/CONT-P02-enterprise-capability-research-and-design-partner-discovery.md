...
Do **not** assume `CONT-P01` passed because a document says “complete.” Re-audit
...
`CONT-P01`. Re-run its full gate and generate a new handoff before resuming this
file.
...
> NOT_EXECUTED **Phase type:** `RESEARCH` **Phase ID:** `CONT-P02`
...
request:
  ...
  current_phase_name:
    Enterprise Capability Research and Design-Partner Discovery
execution_rules:
...
Execute a controlled migration phase that will acquire authoritative user,
domain, platform, legal, data and technical evidence tied to decisions. Preserve
...
- **Out of scope:** Big-bang rewrite, silent permission expansion, unverified
  ...
  evidence.
- **Phase-specific rule:** Use design partners and procurement/security
  questionnaires; avoid one-customer architecture.
...
5. Map regional privacy/student/employment/AI/accessibility/security
   obligations.
6. Use design partners and procurement/security questionnaires; avoid
   one-customer architecture.
...
- Preserve approved architecture: Strangler/expand-contract path with
  ...
  explicit retirement.
- Apply phase rule: Use design partners and procurement/security questionnaires;
  avoid one-customer architecture.
...
Prepare for **Delta Requirements, Compatibility, and Migration Contracts**:
