...
> NOT_EXECUTED **Phase type:** `DISCOVERY` **Phase ID:** `CONT-P00`
...
Execute a controlled migration phase that will establish an evidence-backed
ground truth, source authority, asset and access inventory, unknown
classification, and verified phase map. Preserve backward compatibility,
provenance, user rights and rollback.
...
- **Out of scope:** Big-bang rewrite, silent permission expansion, unverified
  ...
  evidence.
- **Phase-specific rule:** Require MVP
  commit/release/metrics/incidents/SLOs/evals/security/privacy evidence; absent
  evidence blocks.
...
6. Require MVP commit/release/metrics/incidents/SLOs/evals/security/privacy
   evidence; absent evidence blocks.
...
- `DEL-CONT-P00-01` — canonical source register; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P00-02` — asset/access inventory; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P00-03` — maturity matrix; versioned, owned, reviewed and linked.
- `DEL-CONT-P00-04` — unknown/assumption/risk register; versioned, owned,
  reviewed and linked.
- `DEL-CONT-P00-05` — validated phase map; versioned, owned, reviewed and
  linked.
...
Prepare for **Enterprise-Readiness Evidence and Problem Definition**: approved
