# Vaeloom MVP-to-Enterprise Continuation — Independent End-to-End Phase Prompt 12: Agent, Model, Retrieval, and Memory-Taxonomy Migration
...
Do **not** assume `CONT-P11` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.

### Predecessor identity
- **Previous phase:** `CONT-P11 — Backend Service Evolution and Extraction`
- **Current phase:** `CONT-P12 — Agent, Model, Retrieval, and Memory-Taxonomy Migration`
...
## 22. Deliverables
- `DEL-CONT-P11-01` — backend services; versioned, owned, reviewed and linked.
- `DEL-CONT-P11-02` — migrations/jobs; versioned, owned, reviewed and linked.
- `DEL-CONT-P11-03` — authorization/audit; versioned, owned, reviewed and linked.
- `DEL-CONT-P11-04` — contract/integration tests; versioned, owned, reviewed and linked.
- `DEL-CONT-P11-05` — runbooks/dashboards; versioned, owned, reviewed and linked.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `CONT-P11`. Re-run its full gate and generate a new handoff before resuming this file.
...
|---|---|---|---|---|---|---|---|
| PA-CONT-P12-001 | TO_BE_VERIFIED | TO_BE_VERIFIED | TO_BE_VERIFIED | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED | TO_BE_VERIFIED |
...
- Maintain an AI Bill of Materials covering model, prompt, tool, retrieval, embedding, dataset, policy and evaluator versions.
- Evaluate prompt/tool injection, goal hijacking, tool misuse, privilege abuse, memory poisoning, cascading failure and rogue-agent behavior.
- Use shadow mode, canaries, action budgets, confidence thresholds, human approval and trust decay for increasing autonomy.
- Support model/provider fallback and graceful non-AI paths while tracking quality, latency, cost and safety regressions.
...
# Enterprise Execution Prompt — CONT Phase 12: Agent, Model, Retrieval, and Memory-Taxonomy Migration
...
request:
  ...
  current_phase_id: CONT-P12
  current_phase_name: Agent, Model, Retrieval, and Memory-Taxonomy Migration
execution_rules:
...
## 1. Mission
Execute a controlled migration phase that will implement safe agent, retrieval, memory, model, prompt and tool lifecycles with evaluations, provenance and oversight. Preserve backward compatibility, provenance, user rights and rollback.
...
AI/ML Engineer; AI Safety Lead; Data Engineer; Security Architect; Privacy Engineer; Evaluation Engineer; SRE.
...
- **Phase-specific rule:** Run candidate agents in shadow and compare quality, safety, lineage, latency and cost.
...
| BQ-06 | Which providers, data-use terms, eval thresholds and action-risk rules apply? | Material boundary/acceptance | Structured decision with owner/date | Accountable owner | Blocks where unresolved |
...
|---|---|---|---|
| CONT-P12-R01 | Scope | Execute a controlled migration phase that will implement safe agent, retrieval, memory, model, prompt and tool lifecycles with evaluations, provenance and oversight. Preserve backward compatibility, provenance, user rights and rollback. | Approved objective/scope/owners/authority |
| CONT-P12-R02 | Evidence | Every material claim links to authoritative source or reproducible evidence. | No unsupported completion/security/compliance/scale claim |
| CONT-P12-R03 | Security/Privacy | Applicable security, privacy, abuse, rights and AI risks are designed, tested and owned. | No unresolved critical finding or expired waiver |
| CONT-P12-R04 | Quality | Validation covers normal, negative, boundary, failure and recovery. | Critical tests pass in representative environment |
| CONT-P12-R05 | Operations | Ownership, telemetry, support, rollback and lifecycle are included. | Runbook/rollback/telemetry evidence exists |
| CONT-P12-R06 | Data/AI | Data lineage, scope, quality, retention and AI lineage are explicit. | Source/version/owner/lifecycle reconstructable |
| CONT-P12-R07 | Traceability | Requirements map to design, artifacts, tests, evidence, risks and handoff. | No unexplained critical gap |
| CONT-P12-R08 | Gate | Progression is blocked until DoD and weighted gate pass. | Score ≥95 and zero mandatory blockers |
...
## 11. Workstreams
1. **WS-12.1: Agent policy/runtime.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.
2. **WS-12.2: Retrieval/memory writes.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.
3. **WS-12.3: Model/prompt/tool lifecycle.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.
4. **WS-12.4: Evaluation/red-team.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.
5. **WS-12.5: AI operations/cost/oversight.** Assign owner, inputs, dependencies, acceptance, tests, evidence, risks and handoff.

## 12. Detailed Tasks and Subtasks
1. Implement shared agent runtime with mission/tools/memory/risk/budget/timeout/fallback/approval.
2. Treat retrieved/tool content as untrusted and unable to change policy.
3. Implement access-filtered hybrid retrieval with provenance and versioned embeddings/reranking.
4. Implement confidence/contradiction/correction/supersession without fabrication.
5. Version model/prompt/agent/tool/retrieval/policy and record lineage/cost.
6. Build golden/adversarial evals, shadow/canary, fallback and kill switches.
7. Run candidate agents in shadow and compare quality, safety, lineage, latency and cost.
8. For every changed artifact capture compatibility, owner, evidence, rollback and retirement.
...
- Apply phase rule: Run candidate agents in shadow and compare quality, safety, lineage, latency and cost.
...
Run golden/adversarial/injection/tool-policy/memory-poisoning/factuality/privacy/bias/cost tests.
...
## 22. Deliverables
- `DEL-CONT-P12-01` — agent runtime/policies; versioned, owned, reviewed and linked.
- `DEL-CONT-P12-02` — prompt/tool registry; versioned, owned, reviewed and linked.
- `DEL-CONT-P12-03` — retrieval/memory pipelines; versioned, owned, reviewed and linked.
- `DEL-CONT-P12-04` — model router/evals; versioned, owned, reviewed and linked.
- `DEL-CONT-P12-05` — AI observability/kill switches; versioned, owned, reviewed and linked.
- Updated risk, decision, assumption, evidence, traceability and change registers.
- Gate report and next-phase handoff.
...
|---|---|---|---|---|---|---|---|
| EVD-CONT-P12-001 | Replace with real claim | CONT-P12-R01 | file/log/report/approval | TO_BE_VERIFIED | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED |
...
|---|---|---|---|---|---|---|
| RISK-CONT-P12-01 | Docs mistaken for runtime completion | Critical | False readiness | Require runtime evidence/status labels | Phase owner | OPEN |
| RISK-CONT-P12-02 | Scope/permission/data/compatibility assumed | High | Leak/loss/rework | Block or reversible validated decision | Product/Architecture/Security | OPEN |
| RISK-CONT-P12-03 | External API/model/standard changes | High | Regression | Pin versions, tests, owner, kill switch | Integration/AI | OPEN |
| RISK-CONT-P12-04 | Evidence incomplete | High | Untrustworthy gate | Immutable reports and baseline | QA/Release | OPEN |
| RISK-CONT-P12-05 | Old/new divergence | Critical | Data/permission harm | Reconciliation/pause/rollback | Migration | OPEN |
...
TRACK=CONT
PHASE=12
PHASE_NAME=Agent, Model, Retrieval, and Memory-Taxonomy Migration
