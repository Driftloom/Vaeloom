...
Do **not** assume `CONT-P11` passed because a document says “complete.” Re-audit
...
- **Current phase:**
  `CONT-P12 — Agent, Model, Retrieval, and Memory-Taxonomy Migration`
...
- `DEL-CONT-P11-03` — authorization/audit; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P11-04` — contract/integration tests; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P11-05` — runbooks/dashboards; versioned, owned, reviewed and
  linked.
...
`CONT-P11`. Re-run its full gate and generate a new handoff before resuming this
file.
...
> NOT_EXECUTED **Phase type:** `AI_ML` **Phase ID:** `CONT-P12`
...
Execute a controlled migration phase that will implement safe agent, retrieval,
memory, model, prompt and tool lifecycles with evaluations, provenance and
oversight. Preserve backward compatibility, provenance, user rights and
rollback.
...
- **Out of scope:** Big-bang rewrite, silent permission expansion, unverified
  ...
  evidence.
- **Phase-specific rule:** Run candidate agents in shadow and compare quality,
  safety, lineage, latency and cost.
...
7. Run candidate agents in shadow and compare quality, safety, lineage, latency
   and cost.
...
- Preserve approved architecture: Strangler/expand-contract path with
  ...
  explicit retirement.
- Apply phase rule: Run candidate agents in shadow and compare quality, safety,
  lineage, latency and cost.
...
- `DEL-CONT-P12-01` — agent runtime/policies; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P12-02` — prompt/tool registry; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P12-03` — retrieval/memory pipelines; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P12-04` — model router/evals; versioned, owned, reviewed and linked.
- `DEL-CONT-P12-05` — AI observability/kill switches; versioned, owned, reviewed
  and linked.
- Updated risk, decision, assumption, evidence, traceability and change
  registers.
- Gate report and next-phase handoff.
...
Prepare for **Security, Privacy, Compliance, and Identity Uplift**: approved
