...
Do **not** assume `CONT-P20` passed because a document says “complete.” Re-audit
its actual artifacts and evidence before executing this phase.

### Predecessor identity

- **Previous phase:**
  `CONT-P20 — Pilot Validation, Rollback Decision, and Stabilization`
- **Current phase:**
  `CONT-P21 — Scale-Out, Legacy Retirement, and Continuous Optimization`
...
- `DEL-CONT-P20-01` — production validation; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P20-02` — KPI/SLO/data/AI/security review; versioned, owned,
  reviewed and linked.
- `DEL-CONT-P20-03` — incident register; versioned, owned, reviewed and linked.
- `DEL-CONT-P20-04` — continue/rollback decision; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P20-05` — stabilization backlog; versioned, owned, reviewed and
  linked.
...
`CONT-P20`. Re-run its full gate and generate a new handoff before resuming this
file.
...
> NOT_EXECUTED **Phase type:** `MAINTENANCE` **Phase ID:** `CONT-P21`
...
Execute a controlled migration phase that will operate continuous improvement
for incidents, vulnerabilities, dependencies, AI/data drift, costs and lifecycle
retirement. Preserve backward compatibility, provenance, user rights and
rollback.
...
- **Out of scope:** Big-bang rewrite, silent permission expansion, unverified
  ...
  evidence.
- **Phase-specific rule:** Retire only with zero consumers, archived evidence,
  export, approval and communication.
...
6. Retire only with zero consumers, archived evidence, export, approval and
   communication.
...
- Preserve approved architecture: Strangler/expand-contract path with
  ...
  explicit retirement.
- Apply phase rule: Retire only with zero consumers, archived evidence, export,
...
- `DEL-CONT-P21-02` — vulnerability/drift programs; versioned, owned, reviewed
  and linked.
- `DEL-CONT-P21-03` — cost/debt backlog; versioned, owned, reviewed and linked.
- `DEL-CONT-P21-04` — lifecycle/retirement plan; versioned, owned, reviewed and
  linked.
