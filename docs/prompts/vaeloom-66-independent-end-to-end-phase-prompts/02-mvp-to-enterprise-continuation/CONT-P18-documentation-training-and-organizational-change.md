...
Do **not** assume `CONT-P17` passed because a document says “complete.” Re-audit
its actual artifacts and evidence before executing this phase.

### Predecessor identity

- **Previous phase:**
  `CONT-P17 — Dual-Run Observability and Migration Operations`
- **Current phase:**
...
- `DEL-CONT-P17-02` — SLOs/alerts/dashboards; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P17-03` — runbooks/on-call; versioned, owned, reviewed and linked.
- `DEL-CONT-P17-04` — incident/support model; versioned, owned, reviewed and
  linked.
...
`CONT-P17`. Re-run its full gate and generate a new handoff before resuming this
file.
...
> NOT_EXECUTED **Phase type:** `DOCUMENTATION` **Phase ID:** `CONT-P18`
...
Execute a controlled migration phase that will deliver accurate versioned
documentation and training for engineering, operators, support, security and
users. Preserve backward compatibility, provenance, user rights and rollback.
...
- **Out of scope:** Big-bang rewrite, silent permission expansion, unverified
  ...
  evidence.
- **Phase-specific rule:** Publish customer/admin/support/operator migration
  training and deprecation notices.
...
6. Publish customer/admin/support/operator migration training and deprecation
   notices.
...
- Preserve approved architecture: Strangler/expand-contract path with
  ...
  explicit retirement.
- Apply phase rule: Publish customer/admin/support/operator migration training
...
Prepare for **Design-Partner Pilot, Cutover Readiness, and Release**: approved
