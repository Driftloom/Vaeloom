...
Do **not** assume `CONT-P04` passed because a document says “complete.” Re-audit
its actual artifacts and evidence before executing this phase.

### Predecessor identity

- **Previous phase:**
  `CONT-P04 — Migration Program Planning, Waves, and Governance`
...
- `DEL-CONT-P04-03` — RACI/approval matrix; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P04-04` — risk/governance model; versioned, owned, reviewed and
  linked.
- `DEL-CONT-P04-05` — resource/cost scenarios; versioned, owned, reviewed and
  linked.
...
`CONT-P04`. Re-run its full gate and generate a new handoff before resuming this
file.
...
> NOT_EXECUTED **Phase type:** `ARCHITECTURE` **Phase ID:** `CONT-P05`
...
Execute a controlled migration phase that will define implementable
architecture, trust boundaries, component ownership, failure behavior, ADRs and
evolution. Preserve backward compatibility, provenance, user rights and
rollback.
...
- **Out of scope:** Big-bang rewrite, silent permission expansion, unverified
  ...
  evidence.
- **Phase-specific rule:** Define control plane/cells and adapters with ADRs,
  failure domains and data classes.
...
6. Define control plane/cells and adapters with ADRs, failure domains and data
   classes.
...
- Preserve approved architecture: Strangler/expand-contract path with
  ...
  explicit retirement.
- Apply phase rule: Define control plane/cells and adapters with ADRs, failure
  domains and data classes.
...
- `DEL-CONT-P05-01` — C4/trust/data-flow diagrams; versioned, owned, reviewed
  and linked.
...
- `DEL-CONT-P05-04` — threat-informed architecture; versioned, owned, reviewed
  and linked.
- `DEL-CONT-P05-05` — failure/evolution model; versioned, owned, reviewed and
  linked.
- Updated risk, decision, assumption, evidence, traceability and change
  registers.
- Gate report and next-phase handoff.
...
Prepare for **Platform, Toolchain, and Engineering-Standard Evolution**:
