...
Do **not** assume `ENT-P01` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `ENT-P01`. Re-run its full gate and generate a new handoff before resuming this file.
...
- **Phase-specific rule:** Research education and employment use cases separately and classify regional AI/privacy risk.
...
6. Research education and employment use cases separately and classify regional AI/privacy risk.
...
- Apply phase rule: Research education and employment use cases separately and classify regional AI/privacy risk.
