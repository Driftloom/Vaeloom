# Vaeloom Enterprise — Independent End-to-End Phase Prompt 02: Research, Domain Analysis, and Data Discovery
...
Do **not** assume `ENT-P01` passed because a document says “complete.” Re-audit
its actual artifacts and evidence before executing this phase.

### Predecessor identity

- **Previous phase:** `ENT-P01 — Discovery and Problem Definition`
...
`ENT-P01`. Re-run its full gate and generate a new handoff before resuming this
file.
...
| -------------- | ----------------------------------- | ----------------- | ----------------- | ------------ | -------------- | -------------- | ------------------ |
| PA-ENT-P02-001 | TO_BE_VERIFIED                      | TO_BE_VERIFIED    | TO_BE_VERIFIED    | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED | TO_BE_VERIFIED     |
...
- Maintain a living external-dependency radar for connector terms, API quotas,
  model changes, security advisories and regulatory milestones.
- Benchmark build-versus-buy choices with portability, exit cost, privacy,
  reliability and unit economics—not feature count alone.
- Create representative licensed/synthetic datasets and contamination controls
  for retrieval and agent evaluation.
- Track emerging interoperability standards and preserve adapters so no vendor
  or protocol becomes an irreversible dependency.
...
# Enterprise Execution Prompt — ENT Phase 02: Research, Domain Analysis, and Data Discovery
...
> production authorization remain NOT_EXECUTED **Phase type:** `RESEARCH`
> **Phase ID:** `ENT-P02`

```yaml
request:
  mode: GENERATE_AND_EXECUTE_PHASE
  current_phase_id: ENT-P02
...
Acquire authoritative user, domain, platform, legal, data and technical evidence
tied to decisions.
...
Domain Specialist; User Researcher; Data Architect; Security Architect;
Compliance Reviewer; AI/ML Engineer.
...
- **Phase-specific rule:** Research education and employment use cases
  separately and classify regional AI/privacy risk.
...
| ----------- | ---------------- | --------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| ENT-P02-R01 | Scope            | Acquire authoritative user, domain, platform, legal, data and technical evidence tied to decisions. | Approved objective/scope/owners/authority                 |
| ENT-P02-R02 | Evidence         | Every material claim links to authoritative source or reproducible evidence.                        | No unsupported completion/security/compliance/scale claim |
| ENT-P02-R03 | Security/Privacy | Applicable security, privacy, abuse, rights and AI risks are designed, tested and owned.            | No unresolved critical finding or expired waiver          |
| ENT-P02-R04 | Quality          | Validation covers normal, negative, boundary, failure and recovery.                                 | Critical tests pass in representative environment         |
| ENT-P02-R05 | Operations       | Ownership, telemetry, support, rollback and lifecycle are included.                                 | Runbook/rollback/telemetry evidence exists                |
| ENT-P02-R06 | Data/AI          | Data lineage, scope, quality, retention and AI lineage are explicit.                                | Source/version/owner/lifecycle reconstructable            |
| ENT-P02-R07 | Traceability     | Requirements map to design, artifacts, tests, evidence, risks and handoff.                          | No unexplained critical gap                               |
| ENT-P02-R08 | Gate             | Progression is blocked until DoD and weighted gate pass.                                            | Score ≥95 and zero mandatory blockers                     |
...
1. **WS-02.1: User/domain research.** Assign owner, inputs, dependencies,
   acceptance, tests, evidence, risks and handoff.
2. **WS-02.2: Platform/standards research.** Assign owner, inputs, dependencies,
   acceptance, tests, evidence, risks and handoff.
3. **WS-02.3: Data/source feasibility.** Assign owner, inputs, dependencies,
   acceptance, tests, evidence, risks and handoff.
4. **WS-02.4: Legal/privacy/AI-risk analysis.** Assign owner, inputs,
   dependencies, acceptance, tests, evidence, risks and handoff.
5. **WS-02.5: Build-buy evidence.** Assign owner, inputs, dependencies,
   acceptance, tests, evidence, risks and handoff.
...
3. Inspect official API terms, quotas, auth, webhooks, retention and access
   basis.
4. Assess data sensitivity, ownership, licenses, quality, volume and deletion.
5. Map regional privacy/student/employment/AI/accessibility/security
   obligations.
6. Research education and employment use cases separately and classify regional
   AI/privacy risk.
...
- Apply phase rule: Research education and employment use cases separately and
  classify regional AI/privacy risk.
...
Validate source identity, date, applicability, bias, licensing and conflict
resolution.
...
| --------------- | ----------------------- | ----------- | ------------------------ | -------------- | ------------ | -------------- | -------------- |
| EVD-ENT-P02-001 | Replace with real claim | ENT-P02-R01 | file/log/report/approval | TO_BE_VERIFIED | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED |
...
| --------------- | ------------------------------------------- | -------- | -------------------- | --------------------------------------- | ----------------------------- | ------ |
| RISK-ENT-P02-01 | Docs mistaken for runtime completion        | Critical | False readiness      | Require runtime evidence/status labels  | Phase owner                   | OPEN   |
| RISK-ENT-P02-02 | Scope/permission/data/compatibility assumed | High     | Leak/loss/rework     | Block or reversible validated decision  | Product/Architecture/Security | OPEN   |
| RISK-ENT-P02-03 | External API/model/standard changes         | High     | Regression           | Pin versions, tests, owner, kill switch | Integration/AI                | OPEN   |
| RISK-ENT-P02-04 | Evidence incomplete                         | High     | Untrustworthy gate   | Immutable reports and baseline          | QA/Release                    | OPEN   |
| RISK-ENT-P02-05 | Cross-tenant/region/purpose leakage         | Critical | Data/permission harm | Defense-in-depth/independent review     | Security/Data                 | OPEN   |
...
Prepare for **Requirements Engineering**: approved scope/requirements/decisions;
