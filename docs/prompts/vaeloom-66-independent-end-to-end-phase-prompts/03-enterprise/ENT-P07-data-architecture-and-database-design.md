...
Do **not** assume `ENT-P06` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
## 22. Deliverables
- `DEL-ENT-P06-01` — technology decision matrix; versioned, owned, reviewed and linked.
- `DEL-ENT-P06-02` — version policy; versioned, owned, reviewed and linked.
- `DEL-ENT-P06-03` — engineering standards; versioned, owned, reviewed and linked.
- `DEL-ENT-P06-04` — dependency governance; versioned, owned, reviewed and linked.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `ENT-P06`. Re-run its full gate and generate a new handoff before resuming this file.
...
## 1. Mission
Design authoritative data ownership, isolation, provenance, lifecycle, migration, backup, deletion and query strategy.
...
- **Phase-specific rule:** Enforce tenant/org/user/purpose/region in all stores; define each of 22 memory types.
...
7. Enforce tenant/org/user/purpose/region in all stores; define each of 22 memory types.
...
- Apply phase rule: Enforce tenant/org/user/purpose/region in all stores; define each of 22 memory types.
...
## 22. Deliverables
- `DEL-ENT-P07-01` — data models/dictionary; versioned, owned, reviewed and linked.
- `DEL-ENT-P07-02` — migration/rollback plan; versioned, owned, reviewed and linked.
- `DEL-ENT-P07-03` — isolation rules; versioned, owned, reviewed and linked.
- `DEL-ENT-P07-04` — provenance/lifecycle/deletion; versioned, owned, reviewed and linked.
- `DEL-ENT-P07-05` — backup/query evidence; versioned, owned, reviewed and linked.
- Updated risk, decision, assumption, evidence, traceability and change registers.
- Gate report and next-phase handoff.
