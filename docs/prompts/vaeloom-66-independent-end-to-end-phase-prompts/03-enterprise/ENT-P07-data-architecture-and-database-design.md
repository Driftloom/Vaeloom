# Vaeloom Enterprise — Independent End-to-End Phase Prompt 07: Data Architecture and Database Design
...
Do **not** assume `ENT-P06` passed because a document says “complete.” Re-audit
its actual artifacts and evidence before executing this phase.

### Predecessor identity

- **Previous phase:** `ENT-P06 — Technology Stack and Engineering Standards`
...
- `DEL-ENT-P06-01` — technology decision matrix; versioned, owned, reviewed and
  linked.
- `DEL-ENT-P06-02` — version policy; versioned, owned, reviewed and linked.
- `DEL-ENT-P06-03` — engineering standards; versioned, owned, reviewed and
  linked.
- `DEL-ENT-P06-04` — dependency governance; versioned, owned, reviewed and
  linked.
- `DEL-ENT-P06-05` — cost/exit strategy; versioned, owned, reviewed and linked.
...
`ENT-P06`. Re-run its full gate and generate a new handoff before resuming this
file.
...
| -------------- | ----------------------------------- | ----------------- | ----------------- | ------------ | -------------- | -------------- | ------------------ |
| PA-ENT-P07-001 | TO_BE_VERIFIED                      | TO_BE_VERIFIED    | TO_BE_VERIFIED    | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED | TO_BE_VERIFIED     |
...
- Version schemas, embeddings, chunking, graph projections and lineage so
  reprocessing can occur without destructive overwrite.
- Design deletion as a cross-store workflow with primary completion, backup
  expiry, legal hold and user receipts.
- Create reconciliation, projection rebuild, restore and point-in-time recovery
  tests before scale.
- Use synthetic or consented test data with classification and residency
  controls.
...
# Enterprise Execution Prompt — ENT Phase 07: Data Architecture and Database Design
...
> production authorization remain NOT_EXECUTED **Phase type:** `DATA_DESIGN`
> **Phase ID:** `ENT-P07`

```yaml
request:
  mode: GENERATE_AND_EXECUTE_PHASE
  current_phase_id: ENT-P07
  current_phase_name: Data Architecture and Database Design
execution_rules:
...
Design authoritative data ownership, isolation, provenance, lifecycle,
migration, backup, deletion and query strategy.
...
Data Architect; Database Engineer; Privacy Engineer; Security Architect; Data
Engineer; SRE; QA Lead.
...
- **Phase-specific rule:** Enforce tenant/org/user/purpose/region in all stores;
  define each of 22 memory types.
...
| ----------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| ENT-P07-R01 | Scope            | Design authoritative data ownership, isolation, provenance, lifecycle, migration, backup, deletion and query strategy. | Approved objective/scope/owners/authority                 |
| ENT-P07-R02 | Evidence         | Every material claim links to authoritative source or reproducible evidence.                                           | No unsupported completion/security/compliance/scale claim |
| ENT-P07-R03 | Security/Privacy | Applicable security, privacy, abuse, rights and AI risks are designed, tested and owned.                               | No unresolved critical finding or expired waiver          |
| ENT-P07-R04 | Quality          | Validation covers normal, negative, boundary, failure and recovery.                                                    | Critical tests pass in representative environment         |
| ENT-P07-R05 | Operations       | Ownership, telemetry, support, rollback and lifecycle are included.                                                    | Runbook/rollback/telemetry evidence exists                |
| ENT-P07-R06 | Data/AI          | Data lineage, scope, quality, retention and AI lineage are explicit.                                                   | Source/version/owner/lifecycle reconstructable            |
| ENT-P07-R07 | Traceability     | Requirements map to design, artifacts, tests, evidence, risks and handoff.                                             | No unexplained critical gap                               |
| ENT-P07-R08 | Gate             | Progression is blocked until DoD and weighted gate pass.                                                               | Score ≥95 and zero mandatory blockers                     |
...
1. **WS-07.1: Conceptual/logical/physical model.** Assign owner, inputs,
   dependencies, acceptance, tests, evidence, risks and handoff.
2. **WS-07.2: Isolation/authorization invariants.** Assign owner, inputs,
   dependencies, acceptance, tests, evidence, risks and handoff.
3. **WS-07.3: Provenance/lifecycle/rights.** Assign owner, inputs, dependencies,
   acceptance, tests, evidence, risks and handoff.
4. **WS-07.4: Migration/backup/recovery.** Assign owner, inputs, dependencies,
   acceptance, tests, evidence, risks and handoff.
5. **WS-07.5: Indexes/query/capacity.** Assign owner, inputs, dependencies,
   acceptance, tests, evidence, risks and handoff.

## 12. Detailed Tasks and Subtasks

1. Define entities, identifiers, ownership, sensitivity, provenance and
   lifecycle.
...
5. Design correction, supersession, export, deletion, backup expiry and legal
   hold.
6. Benchmark queries/writes and define indexes/partition/capacity triggers.
7. Enforce tenant/org/user/purpose/region in all stores; define each of 22
   memory types.
...
- Apply phase rule: Enforce tenant/org/user/purpose/region in all stores; define
  each of 22 memory types.
...
Run schema/migration/isolation/property/backup/deletion/reconciliation/query
tests.
...
- `DEL-ENT-P07-01` — data models/dictionary; versioned, owned, reviewed and
  linked.
- `DEL-ENT-P07-02` — migration/rollback plan; versioned, owned, reviewed and
  linked.
- `DEL-ENT-P07-03` — isolation rules; versioned, owned, reviewed and linked.
- `DEL-ENT-P07-04` — provenance/lifecycle/deletion; versioned, owned, reviewed
  and linked.
- `DEL-ENT-P07-05` — backup/query evidence; versioned, owned, reviewed and
  linked.
- Updated risk, decision, assumption, evidence, traceability and change
  registers.
- Gate report and next-phase handoff.
...
| --------------- | ----------------------- | ----------- | ------------------------ | -------------- | ------------ | -------------- | -------------- |
| EVD-ENT-P07-001 | Replace with real claim | ENT-P07-R01 | file/log/report/approval | TO_BE_VERIFIED | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED |
...
| --------------- | ------------------------------------------- | -------- | -------------------- | --------------------------------------- | ----------------------------- | ------ |
| RISK-ENT-P07-01 | Docs mistaken for runtime completion        | Critical | False readiness      | Require runtime evidence/status labels  | Phase owner                   | OPEN   |
| RISK-ENT-P07-02 | Scope/permission/data/compatibility assumed | High     | Leak/loss/rework     | Block or reversible validated decision  | Product/Architecture/Security | OPEN   |
| RISK-ENT-P07-03 | External API/model/standard changes         | High     | Regression           | Pin versions, tests, owner, kill switch | Integration/AI                | OPEN   |
| RISK-ENT-P07-04 | Evidence incomplete                         | High     | Untrustworthy gate   | Immutable reports and baseline          | QA/Release                    | OPEN   |
| RISK-ENT-P07-05 | Cross-tenant/region/purpose leakage         | Critical | Data/permission harm | Defense-in-depth/independent review     | Security/Data                 | OPEN   |
...
Prepare for **API, Integration, and Contract Design**: approved
...
TRACK=ENT
PHASE=07
PHASE_NAME=Data Architecture and Database Design
