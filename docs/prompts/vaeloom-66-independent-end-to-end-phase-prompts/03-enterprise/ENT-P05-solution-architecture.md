...
Do **not** assume `ENT-P04` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `ENT-P04`. Re-run its full gate and generate a new handoff before resuming this file.
...
- **Phase-specific rule:** Design control plane/cells, isolation, identity/policy, data/event/plugin/admin/DR.
...
6. Design control plane/cells, isolation, identity/policy, data/event/plugin/admin/DR.
...
- Apply phase rule: Design control plane/cells, isolation, identity/policy, data/event/plugin/admin/DR.
...
## 22. Deliverables
- `DEL-ENT-P05-01` — C4/trust/data-flow diagrams; versioned, owned, reviewed and linked.
...
- `DEL-ENT-P05-04` — threat-informed architecture; versioned, owned, reviewed and linked.
- `DEL-ENT-P05-05` — failure/evolution model; versioned, owned, reviewed and linked.
- Updated risk, decision, assumption, evidence, traceability and change registers.
- Gate report and next-phase handoff.
