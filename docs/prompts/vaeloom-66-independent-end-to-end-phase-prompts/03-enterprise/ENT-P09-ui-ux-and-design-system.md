...
Do **not** assume `ENT-P08` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `ENT-P08`. Re-run its full gate and generate a new handoff before resuming this file.
...
- **Phase-specific rule:** Design personal/org/admin/consent/audit/policy/billing/plugin/region experiences.
...
6. Design personal/org/admin/consent/audit/policy/billing/plugin/region experiences.
...
- Apply phase rule: Design personal/org/admin/consent/audit/policy/billing/plugin/region experiences.
