...
Do **not** assume `ENT-P17` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
- `DEL-ENT-P17-02` — SLOs/alerts/dashboards; versioned, owned, reviewed and linked.
- `DEL-ENT-P17-03` — runbooks/on-call; versioned, owned, reviewed and linked.
- `DEL-ENT-P17-04` — incident/support model; versioned, owned, reviewed and linked.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `ENT-P17`. Re-run its full gate and generate a new handoff before resuming this file.
...
## 1. Mission
Deliver accurate versioned documentation and training for engineering, operators, support, security and users.
...
- **Phase-specific rule:** Deliver trust center, admin/operator/developer docs, API/SDK/MCP portal and training.
...
6. Deliver trust center, admin/operator/developer docs, API/SDK/MCP portal and training.
...
- Apply phase rule: Deliver trust center, admin/operator/developer docs, API/SDK/MCP portal and training.
