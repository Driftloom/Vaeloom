...
Do **not** assume `ENT-P00` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `ENT-P00`. Re-run its full gate and generate a new handoff before resuming this file.
...
## 1. Mission
Validate user, business, trust, safety and operational problems; define measurable outcomes and explicit non-goals.
...
- **Phase-specific rule:** Validate individuals, admins, buyers, security, procurement, privacy and support separately.
...
6. Validate individuals, admins, buyers, security, procurement, privacy and support separately.
...
- Apply phase rule: Validate individuals, admins, buyers, security, procurement, privacy and support separately.
...
- `DEL-ENT-P01-02` — persona/JTBD evidence; versioned, owned, reviewed and linked.
- `DEL-ENT-P01-03` — value/risk hypotheses; versioned, owned, reviewed and linked.
- `DEL-ENT-P01-04` — success metrics; versioned, owned, reviewed and linked.
- `DEL-ENT-P01-05` — non-goals/research backlog; versioned, owned, reviewed and linked.
- Updated risk, decision, assumption, evidence, traceability and change registers.
- Gate report and next-phase handoff.
