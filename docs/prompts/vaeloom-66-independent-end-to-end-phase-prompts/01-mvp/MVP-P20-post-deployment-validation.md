...
Do **not** assume `MVP-P19` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `MVP-P19`. Re-run its full gate and generate a new handoff before resuming this file.
...
- **Phase-specific rule:** Use bounded cohort; monitor trust, corrections, facts, deadlines, deletion, latency, cost and incidents.
...
6. Use bounded cohort; monitor trust, corrections, facts, deadlines, deletion, latency, cost and incidents.
...
- Apply phase rule: Use bounded cohort; monitor trust, corrections, facts, deadlines, deletion, latency, cost and incidents.
