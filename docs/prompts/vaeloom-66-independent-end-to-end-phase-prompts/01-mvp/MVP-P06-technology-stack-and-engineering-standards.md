...
Do **not** assume `MVP-P05` passed because a document says “complete.” Re-audit
its actual artifacts and evidence before executing this phase.

### Predecessor identity

- **Previous phase:** `MVP-P05 — Solution Architecture`
- **Current phase:** `MVP-P06 — Technology Stack and Engineering Standards`
...
`MVP-P05`. Re-run its full gate and generate a new handoff before resuming this
file.
...
> **Phase type:** `TECHNOLOGY_SELECTION` **Phase ID:** `MVP-P06`

```yaml
request:
  mode: GENERATE_AND_EXECUTE_PHASE
  current_phase_id: MVP-P06
...
- **Phase-specific rule:** Avoid premature
  Kubernetes/Kafka/Neo4j/Qdrant/OpenSearch without measured need.
...
| ----------- | ---------------- | -------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| MVP-P06-R01 | Scope            | Select and pin technologies using compatibility, security, performance, cost, support and exit evidence. | Approved objective/scope/owners/authority                 |
| MVP-P06-R02 | Evidence         | Every material claim links to authoritative source or reproducible evidence.                             | No unsupported completion/security/compliance/scale claim |
| MVP-P06-R03 | Security/Privacy | Applicable security, privacy, abuse, rights and AI risks are designed, tested and owned.                 | No unresolved critical finding or expired waiver          |
| MVP-P06-R04 | Quality          | Validation covers normal, negative, boundary, failure and recovery.                                      | Critical tests pass in representative environment         |
| MVP-P06-R05 | Operations       | Ownership, telemetry, support, rollback and lifecycle are included.                                      | Runbook/rollback/telemetry evidence exists                |
| MVP-P06-R06 | Data/AI          | Data lineage, scope, quality, retention and AI lineage are explicit.                                     | Source/version/owner/lifecycle reconstructable            |
| MVP-P06-R07 | Traceability     | Requirements map to design, artifacts, tests, evidence, risks and handoff.                               | No unexplained critical gap                               |
| MVP-P06-R08 | Gate             | Progression is blocked until DoD and weighted gate pass.                                                 | Score ≥95 and zero mandatory blockers                     |
...
6. Avoid premature Kubernetes/Kafka/Neo4j/Qdrant/OpenSearch without measured
   need.
...
- Apply phase rule: Avoid premature Kubernetes/Kafka/Neo4j/Qdrant/OpenSearch
...
| --------------- | ------------------------------------------- | -------- | ------------------ | --------------------------------------- | ----------------------------- | ------ |
| RISK-MVP-P06-01 | Docs mistaken for runtime completion        | Critical | False readiness    | Require runtime evidence/status labels  | Phase owner                   | OPEN   |
| RISK-MVP-P06-02 | Scope/permission/data/compatibility assumed | High     | Leak/loss/rework   | Block or reversible validated decision  | Product/Architecture/Security | OPEN   |
| RISK-MVP-P06-03 | External API/model/standard changes         | High     | Regression         | Pin versions, tests, owner, kill switch | Integration/AI                | OPEN   |
| RISK-MVP-P06-04 | Evidence incomplete                         | High     | Untrustworthy gate | Immutable reports and baseline          | QA/Release                    | OPEN   |
| RISK-MVP-P06-05 | MVP scope expansion                         | High     | Delay/complexity   | Strict scope gate                       | Product                       | OPEN   |
