...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `MVP-P05`. Re-run its full gate and generate a new handoff before resuming this file.
