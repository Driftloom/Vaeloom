...
Do **not** assume `MVP-P08` passed because a document says “complete.” Re-audit
...
`MVP-P08`. Re-run its full gate and generate a new handoff before resuming this
file.
...
> **Phase type:** `UX_DESIGN` **Phase ID:** `MVP-P09`
...
- **Phase-specific rule:** Design approval diff,
  provenance/confidence/correction, scopes and data-right states.
...
6. Design approval diff, provenance/confidence/correction, scopes and data-right
   states.
...
- Apply phase rule: Design approval diff, provenance/confidence/correction,
  scopes and data-right states.
