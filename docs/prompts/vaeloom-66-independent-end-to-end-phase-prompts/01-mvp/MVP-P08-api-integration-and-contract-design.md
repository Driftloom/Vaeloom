...
Do **not** assume `MVP-P07` passed because a document says “complete.” Re-audit
...
`MVP-P07`. Re-run its full gate and generate a new handoff before resuming this
file.
...
> **Phase type:** `API_DESIGN` **Phase ID:** `MVP-P08`
...
- **Phase-specific rule:** Use async jobs, signed/dedup webhooks, approvals,
...
7. Use async jobs, signed/dedup webhooks, approvals, idempotency and
   concurrency.
...
- Apply phase rule: Use async jobs, signed/dedup webhooks, approvals,
  idempotency and concurrency.
...
- `DEL-MVP-P08-02` — event/webhook/job schemas; versioned, owned, reviewed and
  linked.
...
- `DEL-MVP-P08-05` — compatibility/deprecation policy; versioned, owned,
  reviewed and linked.
- Updated risk, decision, assumption, evidence, traceability and change
  registers.
- Gate report and next-phase handoff.
