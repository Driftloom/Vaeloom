...
Do **not** assume `MVP-P01` passed because a document says “complete.” Re-audit
...
`MVP-P01`. Re-run its full gate and generate a new handoff before resuming this
file.
...
> **Phase type:** `RESEARCH` **Phase ID:** `MVP-P02`
...
- **Phase-specific rule:** Research connector rules, job-platform access,
  student privacy and ATS/AI limits.
...
5. Map regional privacy/student/employment/AI/accessibility/security
   obligations.
6. Research connector rules, job-platform access, student privacy and ATS/AI
   limits.
...
- Apply phase rule: Research connector rules, job-platform access, student
  privacy and ATS/AI limits.
