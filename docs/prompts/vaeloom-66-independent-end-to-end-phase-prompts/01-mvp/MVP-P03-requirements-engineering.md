...
Do **not** assume `MVP-P02` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `MVP-P02`. Re-run its full gate and generate a new handoff before resuming this file.
...
- **Phase-specific rule:** Include hardened FR-52–FR-70 and NFR-15–NFR-22 plus approval/provenance/erasure acceptance.
...
6. Include hardened FR-52–FR-70 and NFR-15–NFR-22 plus approval/provenance/erasure acceptance.
...
- Apply phase rule: Include hardened FR-52–FR-70 and NFR-15–NFR-22 plus approval/provenance/erasure acceptance.
