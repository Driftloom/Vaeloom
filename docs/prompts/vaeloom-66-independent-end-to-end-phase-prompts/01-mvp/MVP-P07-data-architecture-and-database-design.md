# Vaeloom MVP — Independent End-to-End Phase Prompt 07: Data Architecture and Database Design
...
Do **not** assume `MVP-P06` passed because a document says “complete.” Re-audit
its actual artifacts and evidence before executing this phase.

### Predecessor identity

- **Previous phase:** `MVP-P06 — Technology Stack and Engineering Standards`
- **Current phase:** `MVP-P07 — Data Architecture and Database Design`
...
- `DEL-MVP-P06-01` — technology decision matrix; versioned, owned, reviewed and
  linked.
- `DEL-MVP-P06-02` — version policy; versioned, owned, reviewed and linked.
- `DEL-MVP-P06-03` — engineering standards; versioned, owned, reviewed and
  linked.
- `DEL-MVP-P06-04` — dependency governance; versioned, owned, reviewed and
  linked.
- `DEL-MVP-P06-05` — cost/exit strategy; versioned, owned, reviewed and linked.
...
`MVP-P06`. Re-run its full gate and generate a new handoff before resuming this
file.
...
| -------------- | ----------------------------------- | ----------------- | ----------------- | ------------ | -------------- | -------------- | ------------------ |
| PA-MVP-P07-001 | TO_BE_VERIFIED                      | TO_BE_VERIFIED    | TO_BE_VERIFIED    | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED | TO_BE_VERIFIED     |
...
# Enterprise Execution Prompt — MVP Phase 07: Data Architecture and Database Design
...
> **Phase type:** `DATA_DESIGN` **Phase ID:** `MVP-P07`

```yaml
request:
  mode: GENERATE_AND_EXECUTE_PHASE
  current_phase_id: MVP-P07
...
- **Phase-specific rule:** Enforce workspace composite constraints/RLS and
...
| ----------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| MVP-P07-R01 | Scope            | Design authoritative data ownership, isolation, provenance, lifecycle, migration, backup, deletion and query strategy. | Approved objective/scope/owners/authority                 |
| MVP-P07-R02 | Evidence         | Every material claim links to authoritative source or reproducible evidence.                                           | No unsupported completion/security/compliance/scale claim |
| MVP-P07-R03 | Security/Privacy | Applicable security, privacy, abuse, rights and AI risks are designed, tested and owned.                               | No unresolved critical finding or expired waiver          |
| MVP-P07-R04 | Quality          | Validation covers normal, negative, boundary, failure and recovery.                                                    | Critical tests pass in representative environment         |
| MVP-P07-R05 | Operations       | Ownership, telemetry, support, rollback and lifecycle are included.                                                    | Runbook/rollback/telemetry evidence exists                |
| MVP-P07-R06 | Data/AI          | Data lineage, scope, quality, retention and AI lineage are explicit.                                                   | Source/version/owner/lifecycle reconstructable            |
| MVP-P07-R07 | Traceability     | Requirements map to design, artifacts, tests, evidence, risks and handoff.                                             | No unexplained critical gap                               |
| MVP-P07-R08 | Gate             | Progression is blocked until DoD and weighted gate pass.                                                               | Score ≥95 and zero mandatory blockers                     |
...
7. Enforce workspace composite constraints/RLS and source/model lineage.
...
- Apply phase rule: Enforce workspace composite constraints/RLS and source/model
  lineage.
...
- `DEL-MVP-P07-01` — data models/dictionary; versioned, owned, reviewed and
  linked.
- `DEL-MVP-P07-02` — migration/rollback plan; versioned, owned, reviewed and
  linked.
- `DEL-MVP-P07-03` — isolation rules; versioned, owned, reviewed and linked.
- `DEL-MVP-P07-04` — provenance/lifecycle/deletion; versioned, owned, reviewed
  and linked.
- `DEL-MVP-P07-05` — backup/query evidence; versioned, owned, reviewed and
  linked.
- Updated risk, decision, assumption, evidence, traceability and change
  registers.
- Gate report and next-phase handoff.
...
| --------------- | ----------------------- | ----------- | ------------------------ | -------------- | ------------ | -------------- | -------------- |
| EVD-MVP-P07-001 | Replace with real claim | MVP-P07-R01 | file/log/report/approval | TO_BE_VERIFIED | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED |
...
| --------------- | ------------------------------------------- | -------- | ------------------ | --------------------------------------- | ----------------------------- | ------ |
| RISK-MVP-P07-01 | Docs mistaken for runtime completion        | Critical | False readiness    | Require runtime evidence/status labels  | Phase owner                   | OPEN   |
| RISK-MVP-P07-02 | Scope/permission/data/compatibility assumed | High     | Leak/loss/rework   | Block or reversible validated decision  | Product/Architecture/Security | OPEN   |
| RISK-MVP-P07-03 | External API/model/standard changes         | High     | Regression         | Pin versions, tests, owner, kill switch | Integration/AI                | OPEN   |
| RISK-MVP-P07-04 | Evidence incomplete                         | High     | Untrustworthy gate | Immutable reports and baseline          | QA/Release                    | OPEN   |
| RISK-MVP-P07-05 | MVP scope expansion                         | High     | Delay/complexity   | Strict scope gate                       | Product                       | OPEN   |
