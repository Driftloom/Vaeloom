...
Do **not** assume `MVP-P06` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
## 22. Deliverables
- `DEL-MVP-P06-01` — technology decision matrix; versioned, owned, reviewed and linked.
- `DEL-MVP-P06-02` — version policy; versioned, owned, reviewed and linked.
- `DEL-MVP-P06-03` — engineering standards; versioned, owned, reviewed and linked.
- `DEL-MVP-P06-04` — dependency governance; versioned, owned, reviewed and linked.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `MVP-P06`. Re-run its full gate and generate a new handoff before resuming this file.
...
- **Phase-specific rule:** Enforce workspace composite constraints/RLS and source/model lineage.
...
- Apply phase rule: Enforce workspace composite constraints/RLS and source/model lineage.
