...
Do **not** assume `MVP-P18` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
- `DEL-MVP-P18-02` — API/operator/user/security docs; versioned, owned, reviewed and linked.
- `DEL-MVP-P18-03` — ADR index; versioned, owned, reviewed and linked.
- `DEL-MVP-P18-04` — training; versioned, owned, reviewed and linked.
- `DEL-MVP-P18-05` — docs tests/ownership; versioned, owned, reviewed and linked.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `MVP-P18`. Re-run its full gate and generate a new handoff before resuming this file.
...
- **Phase-specific rule:** No launch without legal/age policy, connector basis, pentest, evals, accessibility, restore and support.
...
6. No launch without legal/age policy, connector basis, pentest, evals, accessibility, restore and support.
...
- Apply phase rule: No launch without legal/age policy, connector basis, pentest, evals, accessibility, restore and support.
...
## 22. Deliverables
- `DEL-MVP-P19-01` — release candidate/evidence index; versioned, owned, reviewed and linked.
- `DEL-MVP-P19-02` — go-no-go; versioned, owned, reviewed and linked.
- `DEL-MVP-P19-03` — cutover/rollback rehearsal; versioned, owned, reviewed and linked.
- `DEL-MVP-P19-04` — support pack; versioned, owned, reviewed and linked.
- `DEL-MVP-P19-05` — production authorization; versioned, owned, reviewed and linked.
- Updated risk, decision, assumption, evidence, traceability and change registers.
- Gate report and next-phase handoff.
