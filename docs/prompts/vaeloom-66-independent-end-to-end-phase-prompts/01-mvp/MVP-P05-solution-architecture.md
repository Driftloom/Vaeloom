...
Do **not** assume `MVP-P04` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
- `DEL-MVP-P04-03` — RACI/approval matrix; versioned, owned, reviewed and linked.
- `DEL-MVP-P04-04` — risk/governance model; versioned, owned, reviewed and linked.
- `DEL-MVP-P04-05` — resource/cost scenarios; versioned, owned, reviewed and linked.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `MVP-P04`. Re-run its full gate and generate a new handoff before resuming this file.
...
## 1. Mission
Define implementable architecture, trust boundaries, component ownership, failure behavior, ADRs and evolution.
...
- **Phase-specific rule:** Use verified workspace identity, service identity and authoritative-vs-projection boundaries.
...
6. Use verified workspace identity, service identity and authoritative-vs-projection boundaries.
...
- Apply phase rule: Use verified workspace identity, service identity and authoritative-vs-projection boundaries.
...
## 22. Deliverables
- `DEL-MVP-P05-01` — C4/trust/data-flow diagrams; versioned, owned, reviewed and linked.
...
- `DEL-MVP-P05-04` — threat-informed architecture; versioned, owned, reviewed and linked.
- `DEL-MVP-P05-05` — failure/evolution model; versioned, owned, reviewed and linked.
- Updated risk, decision, assumption, evidence, traceability and change registers.
- Gate report and next-phase handoff.
