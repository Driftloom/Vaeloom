...
Do **not** assume `MVP-P00` passed because a document says “complete.” Re-audit
its actual artifacts and evidence before executing this phase.

### Predecessor identity

- **Previous phase:** `MVP-P00 — Intake and Existing-State Assessment`
- **Current phase:** `MVP-P01 — Discovery and Problem Definition`
...
`MVP-P00`. Re-run its full gate and generate a new handoff before resuming this
file.
...
| -------------- | ----------------------------------- | ----------------- | ----------------- | ------------ | -------------- | -------------- | ------------------ |
| PA-MVP-P01-001 | TO_BE_VERIFIED                      | TO_BE_VERIFIED    | TO_BE_VERIFIED    | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED | TO_BE_VERIFIED     |
...
> **Phase type:** `DISCOVERY` **Phase ID:** `MVP-P01`

```yaml
request:
  mode: GENERATE_AND_EXECUTE_PHASE
  current_phase_id: MVP-P01
...
- **Phase-specific rule:** Validate the student/early-career wedge without
...
| ----------- | ---------------- | ------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| MVP-P01-R01 | Scope            | Validate user, business, trust, safety and operational problems; define measurable outcomes and explicit non-goals. | Approved objective/scope/owners/authority                 |
| MVP-P01-R02 | Evidence         | Every material claim links to authoritative source or reproducible evidence.                                        | No unsupported completion/security/compliance/scale claim |
| MVP-P01-R03 | Security/Privacy | Applicable security, privacy, abuse, rights and AI risks are designed, tested and owned.                            | No unresolved critical finding or expired waiver          |
| MVP-P01-R04 | Quality          | Validation covers normal, negative, boundary, failure and recovery.                                                 | Critical tests pass in representative environment         |
| MVP-P01-R05 | Operations       | Ownership, telemetry, support, rollback and lifecycle are included.                                                 | Runbook/rollback/telemetry evidence exists                |
| MVP-P01-R06 | Data/AI          | Data lineage, scope, quality, retention and AI lineage are explicit.                                                | Source/version/owner/lifecycle reconstructable            |
| MVP-P01-R07 | Traceability     | Requirements map to design, artifacts, tests, evidence, risks and handoff.                                          | No unexplained critical gap                               |
| MVP-P01-R08 | Gate             | Progression is blocked until DoD and weighted gate pass.                                                            | Score ≥95 and zero mandatory blockers                     |
...
6. Validate the student/early-career wedge without claiming product-market fit.
...
- Apply phase rule: Validate the student/early-career wedge without claiming
  product-market fit.
...
- `DEL-MVP-P01-02` — persona/JTBD evidence; versioned, owned, reviewed and
  linked.
- `DEL-MVP-P01-03` — value/risk hypotheses; versioned, owned, reviewed and
  linked.
- `DEL-MVP-P01-04` — success metrics; versioned, owned, reviewed and linked.
- `DEL-MVP-P01-05` — non-goals/research backlog; versioned, owned, reviewed and
  linked.
- Updated risk, decision, assumption, evidence, traceability and change
  registers.
- Gate report and next-phase handoff.
...
| --------------- | ----------------------- | ----------- | ------------------------ | -------------- | ------------ | -------------- | -------------- |
| EVD-MVP-P01-001 | Replace with real claim | MVP-P01-R01 | file/log/report/approval | TO_BE_VERIFIED | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED |
...
| --------------- | ------------------------------------------- | -------- | ------------------ | --------------------------------------- | ----------------------------- | ------ |
| RISK-MVP-P01-01 | Docs mistaken for runtime completion        | Critical | False readiness    | Require runtime evidence/status labels  | Phase owner                   | OPEN   |
| RISK-MVP-P01-02 | Scope/permission/data/compatibility assumed | High     | Leak/loss/rework   | Block or reversible validated decision  | Product/Architecture/Security | OPEN   |
| RISK-MVP-P01-03 | External API/model/standard changes         | High     | Regression         | Pin versions, tests, owner, kill switch | Integration/AI                | OPEN   |
| RISK-MVP-P01-04 | Evidence incomplete                         | High     | Untrustworthy gate | Immutable reports and baseline          | QA/Release                    | OPEN   |
| RISK-MVP-P01-05 | MVP scope expansion                         | High     | Delay/complexity   | Strict scope gate                       | Product                       | OPEN   |
