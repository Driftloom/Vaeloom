...
Do **not** assume `MVP-P10` passed because a document says “complete.” Re-audit
its actual artifacts and evidence before executing this phase.

### Predecessor identity

- **Previous phase:** `MVP-P10 — Frontend Implementation`
- **Current phase:** `MVP-P11 — Backend Implementation`
...
- `DEL-MVP-P10-01` — frontend code; versioned, owned, reviewed and linked.
- `DEL-MVP-P10-02` — typed client/state; versioned, owned, reviewed and linked.
- `DEL-MVP-P10-03` — component library; versioned, owned, reviewed and linked.
- `DEL-MVP-P10-04` — accessibility/tests; versioned, owned, reviewed and linked.
- `DEL-MVP-P10-05` — performance/deploy notes; versioned, owned, reviewed and
  linked.
...
`MVP-P10`. Re-run its full gate and generate a new handoff before resuming this
file.
...
| -------------- | ----------------------------------- | ----------------- | ----------------- | ------------ | -------------- | -------------- | ------------------ |
| PA-MVP-P11-001 | TO_BE_VERIFIED                      | TO_BE_VERIFIED    | TO_BE_VERIFIED    | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED | TO_BE_VERIFIED     |
...
# Enterprise Execution Prompt — MVP Phase 11: Backend Implementation
...
> **Phase type:** `BACKEND_IMPLEMENTATION` **Phase ID:** `MVP-P11`

```yaml
request:
  mode: GENERATE_AND_EXECUTE_PHASE
  current_phase_id: MVP-P11
...
- **Phase-specific rule:** Implement identity/isolation before files or agents;
  enforce scope everywhere.
...
| ----------- | ---------------- | ---------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| MVP-P11-R01 | Scope            | Implement core services with authorization, isolation, async processing, idempotency, integrity, audit and operations. | Approved objective/scope/owners/authority                 |
| MVP-P11-R02 | Evidence         | Every material claim links to authoritative source or reproducible evidence.                                           | No unsupported completion/security/compliance/scale claim |
| MVP-P11-R03 | Security/Privacy | Applicable security, privacy, abuse, rights and AI risks are designed, tested and owned.                               | No unresolved critical finding or expired waiver          |
| MVP-P11-R04 | Quality          | Validation covers normal, negative, boundary, failure and recovery.                                                    | Critical tests pass in representative environment         |
| MVP-P11-R05 | Operations       | Ownership, telemetry, support, rollback and lifecycle are included.                                                    | Runbook/rollback/telemetry evidence exists                |
| MVP-P11-R06 | Data/AI          | Data lineage, scope, quality, retention and AI lineage are explicit.                                                   | Source/version/owner/lifecycle reconstructable            |
| MVP-P11-R07 | Traceability     | Requirements map to design, artifacts, tests, evidence, risks and handoff.                                             | No unexplained critical gap                               |
| MVP-P11-R08 | Gate             | Progression is blocked until DoD and weighted gate pass.                                                               | Score ≥95 and zero mandatory blockers                     |
...
6. Implement identity/isolation before files or agents; enforce scope
   everywhere.
...
- Apply phase rule: Implement identity/isolation before files or agents; enforce
  scope everywhere.
...
| --------------- | ----------------------- | ----------- | ------------------------ | -------------- | ------------ | -------------- | -------------- |
| EVD-MVP-P11-001 | Replace with real claim | MVP-P11-R01 | file/log/report/approval | TO_BE_VERIFIED | NOT_EXECUTED | TO_BE_VERIFIED | TO_BE_VERIFIED |
...
| --------------- | ------------------------------------------- | -------- | ------------------ | --------------------------------------- | ----------------------------- | ------ |
| RISK-MVP-P11-01 | Docs mistaken for runtime completion        | Critical | False readiness    | Require runtime evidence/status labels  | Phase owner                   | OPEN   |
| RISK-MVP-P11-02 | Scope/permission/data/compatibility assumed | High     | Leak/loss/rework   | Block or reversible validated decision  | Product/Architecture/Security | OPEN   |
| RISK-MVP-P11-03 | External API/model/standard changes         | High     | Regression         | Pin versions, tests, owner, kill switch | Integration/AI                | OPEN   |
| RISK-MVP-P11-04 | Evidence incomplete                         | High     | Untrustworthy gate | Immutable reports and baseline          | QA/Release                    | OPEN   |
| RISK-MVP-P11-05 | MVP scope expansion                         | High     | Delay/complexity   | Strict scope gate                       | Product                       | OPEN   |
