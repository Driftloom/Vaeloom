...
- **Current phase:** `MVP-P12 — AI, Agent, Memory, and Data-Pipeline Implementation`
...
- `DEL-MVP-P11-04` — contract/integration tests; versioned, owned, reviewed and linked.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `MVP-P11`. Re-run its full gate and generate a new handoff before resuming this file.
...
- **Phase-specific rule:** Route only to canonical eight agents; isolate untrusted content; prohibit fabrication.
...
7. Route only to canonical eight agents; isolate untrusted content; prohibit fabrication.
...
- Apply phase rule: Route only to canonical eight agents; isolate untrusted content; prohibit fabrication.
