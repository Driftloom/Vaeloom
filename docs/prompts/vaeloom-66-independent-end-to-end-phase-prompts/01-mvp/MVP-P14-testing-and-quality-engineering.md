...
Do **not** assume `MVP-P13` passed because a document says “complete.” Re-audit its actual artifacts and evidence before executing this phase.
...
On `NO-GO`, switch to `AUDIT_COMPLETED_PHASE` then `REMEDIATE_FAILED_PHASE` for `MVP-P13`. Re-run its full gate and generate a new handoff before resuming this file.
...
- **Phase-specific rule:** Test ingest-memory, approvals, resume/ATS, lawful job handoff, Gmail, rights and isolation.
...
6. Test ingest-memory, approvals, resume/ATS, lawful job handoff, Gmail, rights and isolation.
...
- Apply phase rule: Test ingest-memory, approvals, resume/ATS, lawful job handoff, Gmail, rights and isolation.
...
## 22. Deliverables
- `DEL-MVP-P14-01` — test strategy/suites; versioned, owned, reviewed and linked.
- `DEL-MVP-P14-02` — coverage report; versioned, owned, reviewed and linked.
- `DEL-MVP-P14-03` — defect/waiver register; versioned, owned, reviewed and linked.
