...
> standards for all Vaeloom services across environments **Status:** 🆕 New
...
`apps/web` (Next.js) and `apps/api` (FastAPI, including all AI logic), with
...
### Full Config — `apps/api` (AI section)
