...
class ResearchAgent(BaseAgent):
    """Research Agent - Deep market intelligence, company compensation benchmarks, and industry news."""
    ...
    async def run_step(self, context: AgentTurnContext, token: CancellationToken) -> ReActStep:
        ...
        return ReActStep(
            ...
            thought=f"Executing Research Agent plan for input: {context.user_prompt}",
            is_final=True,
            final_answer=f"Result from Research Agent",
        )
