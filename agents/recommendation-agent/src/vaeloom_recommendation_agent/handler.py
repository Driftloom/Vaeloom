...
class RecommendationAgent(BaseAgent):
    """Recommendation Agent - Personalized career move proposals and project recommendations."""
    ...
    async def run_step(self, context: AgentTurnContext, token: CancellationToken) -> ReActStep:
        ...
        return ReActStep(
            ...
            thought=f"Executing Recommendation Agent plan for input: {context.user_prompt}",
            is_final=True,
            final_answer=f"Result from Recommendation Agent",
        )
