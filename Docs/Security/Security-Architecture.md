...
> **Purpose:** Define the security architecture for Meridian
> **Status:** ✅ Upgraded to enterprise quality
> **Owner:** Security Team
> **Last Updated:** 2026-07-13
> **Canonical source:** [`/Docs/06-Meridian-Enterprise-Paper.md#19-security--compliance`](../../Docs/06-Meridian-Enterprise-Paper.md#19-security--compliance)
...
|----------|---------|---------|----------|
| AUTH_PROVIDER_URL | Auth service endpoint | https://auth.meridian.dev | Yes |
| JWT_ISSUER | Expected JWT issuer | https://auth.meridian.dev | Yes |
| JWT_AUDIENCE | Expected JWT audience | api.meridian.dev | Yes |
...
| CORS_ORIGINS | Allowed CORS origins | https://app.meridian.dev | Yes |
...
resource "aws_security_group" "api_service" {
  ...
  description = "Security group for Meridian API service"
...
- [IAM.md](./IAM.md)
- [`/Docs/06-Meridian-Enterprise-Paper.md#19-security--compliance`](../../Docs/06-Meridian-Enterprise-Paper.md#19-security--compliance)
