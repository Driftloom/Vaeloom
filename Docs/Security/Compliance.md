...
> **Purpose:** Define compliance requirements and posture for Meridian
...
Meridian's architecture is designed with compliance as a core constraint, not an afterthought:
