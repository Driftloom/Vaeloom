...
> **Purpose:** Define the business logic layer architecture for Meridian
> **Status:** 🆕 New
...
2. **Domain logic centralization** — Keep all Meridian business rules (document processing, memory extraction, resume generation) in dedicated service modules, not scattered across controllers or event handlers
...
import { Workflow } from '@meridian/workflow';
...
from meridian.rules import RuleEngine
...
meridian rules list --workspace ws_abc123 --enabled
```
