...
> **Purpose:** Define the authorization model for Meridian
> **Canonical source:** [`/Docs/06-Meridian-Enterprise-Paper.md#193-permission-engine`](../../Docs/06-Meridian-Enterprise-Paper.md#193-permission-engine)
...
graph TD
    ...
    subgraph PermissionEngine["🛡️ Permission Engine (ABAC)"]
        direction TB
...
Meridian uses a **Permission Engine** that implements **Attribute-Based Access Control (ABAC)** under the hood (see [`ABAC.md`](./ABAC.md) for the detailed policy model). Every request — user or agent — is evaluated against four attribute categories:
...
import { authorize } from '@meridian/auth';
...
from meridian.access_control import RoleManager
...
curl -X GET "https://api.meridian.ai/v1/users/user_42/permissions" \
...
- [RBAC.md](./RBAC.md)
- [`/Docs/06-Meridian-Enterprise-Paper.md#193-permission-engine`](../../Docs/06-Meridian-Enterprise-Paper.md#193-permission-engine)
