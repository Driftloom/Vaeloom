...
> **Purpose:** Define the authentication strategy for Meridian
> **Canonical source:** [`/Docs/06-Meridian-Enterprise-Paper.md#191-authentication--access`](../../Docs/06-Meridian-Enterprise-Paper.md#191-authentication--access)
...
import { MeridianAuth } from '@meridian/auth';

const auth = new MeridianAuth();
...
from meridian.auth import OAuthClient

oauth = OAuthClient(
    client_id="...",
    client_secret="...",
    token_url="https://auth.meridian.ai/oauth/token",
)
...
curl -X POST "https://auth.meridian.ai/oauth/token" \
...
- [`/Docs/06-Meridian-Enterprise-Paper.md#191-authentication--access`](../../Docs/06-Meridian-Enterprise-Paper.md#191-authentication--access)
