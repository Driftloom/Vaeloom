...
> **Purpose:** Define distributed tracing standards for Meridian
> **Status:** 🆕 New
...
- Instrument all Meridian services with OpenTelemetry for distributed trace generation
...
const tracer = trace.getTracer('meridian-api');
...
jaeger-query --service meridian-api --limit 10 --tags 'error=true'
