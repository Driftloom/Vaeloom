...
> **Canonical source:** [`/Docs/Vaeloom-Complete-Documentation.md#14-roadmap`](../../Docs/Vaeloom-Complete-Documentation.md#14-roadmap)

## Roadmap Overview

```mermaid
gantt
    title Vaeloom Product Roadmap â€” MVP through Enterprise
    dateFormat  YYYY-MM-DD
    axisFormat  %b %Y
    tickInterval 3month

    section ðŸš€ MVP (Phases 0-6)
        ...
        MVP Launch ðŸŽ‰                   :milestone, mvp6, 2027-01-15, 1d

    section âš¡ v1.5 â€” Autonomy
        ...
        v1.5 Release ðŸš€                :milestone, v15_4, 2027-05-01, 1d

    section ðŸ§  V2 â€” Memory Graph
        ...
        V2 Launch ðŸš€                   :milestone, v2_5, 2027-10-01, 1d

    section ðŸ¤– V3 â€” Full Agent Roster
        ...
        V3 Launch ðŸš€                   :milestone, v3_4, 2028-02-01, 1d

    section ðŸ¢ Enterprise
        ...
        Enterprise GA ðŸ¢              :milestone, ent_4, 2028-07-01, 1d
```

> **Chart:** The product roadmap spans 4 years from MVP through Enterprise. **MVP** (ðŸš€) delivers core ingestion, organization, and agent capabilities in 6 phases over 6 months. **v1.5** (âš¡) layers autonomy and learning feedback. **V2** (ðŸ§ ) expands memory to 20 types with graph visualization. **V3** (ðŸ¤–) completes the 28-agent roster. **Enterprise** (ðŸ¢) adds multi-tenancy, SSO, compliance, and a plugin marketplace. Milestones mark each major release.
...
**MVP (Phases 0-6)** â€” Implementation not yet started. Full build order defined in [`build-prompts/mvp/`](../../Documents/build-prompts/mvp/).

## Common Mistakes

| Mistake | Consequence |
|---------|-------------|
| Over-promising on timelines | Public roadmaps with specific dates become liabilities when priorities shift â€” users and stakeholders hold you to them |
| Confusing roadmap with release plan | A roadmap communicates direction and priorities â€” exact dates and specific features belong in a release plan |
...
| Never removing items | Roadmaps that only add and never remove become impossibly long â€” stale items erode credibility |

## Best Practices

| Practice | Why |
|----------|-----|
| Use now/next/later buckets instead of specific dates | Stakeholders need to know the order of priorities, not the exact ship date â€” "next" communicates soon without committing to a month |
...
| Include exit criteria for each stage | Each stage should have a clear "done" condition â€” "real users complete first-week journey unaided" is better than "launch MVP" |
...
|--------------|-----------|
| Roadmap confidentiality | Early-stage feature plans and enterprise timelines are commercially sensitive â€” share with NDA where appropriate |
...
1. Current phase nears completion â€” engineering lead runs exit criteria checklist
...
| Phase exit criteria may not capture user satisfaction | "Technical completion" â‰  "user value" | Include at least one user-experience metric per exit criterion (approval rate, NPS, retention) | Develop composite "phase health score" combining technical and experience metrics |
...
curl -s https://api.Vaeloom.dev/v1/admin/roadmap/phase/mvp/check \
...
|--------------|----------|
| Phase capacity planning | Each roadmap phase should include infrastructure scaling estimates â€” don't assume current capacity will serve next phase |
| Milestone performance gates | Each release milestone must include a performance regression check â€” no feature ships that degrades p95 response time |
...
- [`/Docs/Vaeloom-Complete-Documentation.md#14-roadmap`](../../Docs/Vaeloom-Complete-Documentation.md#14-roadmap)
- [`/Docs/Vaeloom-Complete-Documentation.md#12-implementation-plan`](../../Docs/Vaeloom-Complete-Documentation.md#12-implementation-plan)
