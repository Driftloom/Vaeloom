...
> **Purpose:** Catalogue of all Meridian features
> **Status:** ✅ Upgraded to enterprise quality
> **Owner:** Product Team
> **Last Updated:** 2026-07-13
> **Canonical source:** [`/Docs/Meridian-Complete-Documentation.md#7-features`](../../Docs/Meridian-Complete-Documentation.md#7-features)
...
| Mobile not available in MVP | Users cannot access Meridian on mobile devices | Responsive web design provides basic mobile experience | Native mobile apps (iOS, Android) in V3 |
...
curl -s https://api.meridian.dev/v1/features/check \
...
- [`/Docs/Meridian-Complete-Documentation.md#7-features`](../../Docs/Meridian-Complete-Documentation.md#7-features)
