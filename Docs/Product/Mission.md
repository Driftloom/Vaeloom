...
> **Purpose:** Define the mission that drives Meridian
> **Canonical source:** [`/Docs/Meridian-Complete-Documentation.md#2-the-product-story`](../../Docs/Meridian-Complete-Documentation.md#2-the-product-story)
...
The status quo forces every person to manually re-assemble scattered information about their own life every time it matters — updating a resume, remembering achievements, applying to opportunities. This is exactly the kind of work that never gets prioritized until a deadline forces it, at which point it's too late to do well. Meridian exists to make this re-assembly automatic and continuous.
...
| Use the "one brain" metaphor consistently | "Chat is one view into your Meridian brain" builds a clear mental model for users |
...
- External stakeholders (users, partners, investors) associate Meridian with "trustworthy personal AI" within 18 months
...
curl -s -X POST https://api.meridian.dev/v1/admin/mission-check \
...
- [`/Docs/Meridian-Complete-Documentation.md#12-executive-summary`](../../Docs/Meridian-Complete-Documentation.md#12-executive-summary)
