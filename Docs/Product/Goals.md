...
> **Purpose:** Define measurable product goals for Meridian
> **Canonical source:** [`/Docs/06-Meridian-Enterprise-Paper.md#13-goals`](../../Docs/06-Meridian-Enterprise-Paper.md#13-goals)
...
| Platform, not silo | Third parties can extend Meridian through a real plugin/MCP ecosystem |
...
curl -s https://api.meridian.dev/v1/admin/goals/status \
...
- [`/Docs/06-Meridian-Enterprise-Paper.md#13-goals`](../../Docs/06-Meridian-Enterprise-Paper.md#13-goals)
