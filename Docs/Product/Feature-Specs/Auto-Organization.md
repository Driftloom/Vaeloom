...
curl -X GET https://api.meridian.dev/v1/workspaces/{id}/files/organization/proposals \
...
# Approve proposal
curl -X POST https://api.meridian.dev/v1/workspaces/{id}/files/organization/approve \
  -H "Authorization: Bearer $TOKEN" \
