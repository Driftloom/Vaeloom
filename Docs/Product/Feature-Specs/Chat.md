...
| **Out of Scope** | Voice/video chat (text-only in MVP); image generation; autonomous action without user intent — all actions require user message; conversation export outside Meridian; multi-user chat; agent-to-agent conversation without human context |
...
- `/Docs/Meridian-Complete-Documentation.md#5-ai-agents`
