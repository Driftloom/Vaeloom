...
> **Purpose:** Define the animation and transition system for Meridian
> **Status:** 🆕 New
...
graph TD
    ...
    subgraph Types["⏱️ Animation Types"]
...
3. **Storage**: Animation preferences stored in localStorage (`meridian-reduced-motion`) → OS preference monitored via matchMedia listener
