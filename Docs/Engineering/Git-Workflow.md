...
> **Purpose:** Define the Git workflow for Meridian engineering
> **Status:** 🆕 New
...
Every engineer working on the Meridian monorepo follows this workflow. It integrates with the branch protection rules in `Branch-Strategy.md`, the commit format in `Commit-Convention.md`, and the PR process in `PR-Guidelines.md`.
