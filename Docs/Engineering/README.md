...
5. Serve as the onboarding entry point for new engineers joining the Meridian engineering team

## What's here

| Document | Location | Status |
|----------|----------|--------|
| Tech Stack & Rationale | [`/Docs/Meridian-Complete-Documentation.md#10-tech-stack`](../../Docs/Meridian-Complete-Documentation.md#10-tech-stack) | ✅ Excellent |
...
| Implementation Blueprint | [`/Docs/Meridian-Complete-Documentation.md#13-implementation-blueprint`](../../Docs/Meridian-Complete-Documentation.md#13-implementation-blueprint) | ✅ Good |
...
### Out of Scope
- Detailed product specifications (covered in `Meridian-Complete-Documentation.md` and `01-Meridian-MVP-Spec.md`)
...
```bash
# Quick start with Meridian engineering tools
meridian init my-project
cd my-project
meridian dev                                    # Start dev environment

# Run the full test suite
meridian test --coverage
meridian lint --fix
```

```bash
# Build and release
meridian build --env production
meridian release patch                           # Bump version & tag
meridian deploy --environment staging
```

```bash
# Code quality checks
meridian check types                            # TypeScript type checking
meridian check format                           # Format all source files
meridian audit dependencies                     # Check for vulnerable deps
```
