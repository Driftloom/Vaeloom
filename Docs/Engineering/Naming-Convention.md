...
| Docker images | kebab-case | `Vaeloom-api` |
...
# Environment variables (UPPER_SNAKE_CASE with Vaeloom_ prefix)
Vaeloom_DATABASE_URL=postgresql://localhost:5432/Vaeloom
Vaeloom_REDIS_URL=redis://localhost:6379
Vaeloom_JWT_SECRET=<secret>
Vaeloom_LOG_LEVEL=debug
