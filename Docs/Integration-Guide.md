...
| **Connector Templates / Scaffolding** | High | Low | Q4 2026 — CLI tool (`Vaeloom connector:create`) that generates a complete connector project from a template — manifest, OAuth, sync, tests, CI |
