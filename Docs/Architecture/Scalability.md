...
> **Purpose:** Define the scalability strategy for Meridian
> **Status:** ✅ Upgraded to enterprise quality
> **Canonical source:** [`/Docs/Meridian-Complete-Documentation.md#10-tech-stack`](../../Docs/Meridian-Complete-Documentation.md#10-tech-stack)
...
```bash
meridian scale history --service api --window 24h --format json
```

### Add a read replica

```bash
meridian db replica create --region us-west-2 --source production
```

### Simulate traffic for scaling test

```bash
meridian scale simulate --rps 1000 --duration 5m --service api
```
