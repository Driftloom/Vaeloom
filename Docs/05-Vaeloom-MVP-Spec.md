> **⚠️ SUPERSEDED — alternative-formatting draft, kept for history only.**
> The canonical MVP product spec is [`01-Vaeloom-MVP-Spec.md`](./01-Vaeloom-MVP-Spec.md),
> and the live, categorized product documentation lives under [`./Product/`](./Product/).
