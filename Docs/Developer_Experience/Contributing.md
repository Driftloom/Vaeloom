...
> **Purpose:** Guide for contributing to the Meridian project
> **Status:** 🆕 New
...
Thank you for considering contributing to Meridian. This document outlines the process for contributing.
...
4. Join our [Discord](https://discord.gg/meridian) for questions
...
The Contributing guide defines how developers can contribute to the Meridian project — reporting bugs, suggesting features, and submitting pull requests. It covers the contribution workflow from discovering issues through merging PRs, including coding standards, testing requirements, and documentation expectations.
...
- [CLI.md](./CLI.md)
- [`/Docs/Meridian-Complete-Documentation.md`](../../Docs/Meridian-Complete-Documentation.md)
