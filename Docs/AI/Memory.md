...
> **Purpose:** Define the memory system architecture for Meridian's AI
> **Status:** ✅ Upgraded to enterprise quality
> **Owner:** AI Team
> **Last Updated:** 2026-07-13
> **Canonical source:** [`/Docs/04-memory-knowledge-graph.md`](../../Docs/04-memory-knowledge-graph.md), [`/Docs/Meridian-Complete-Documentation.md#6-memory-system-in-depth`](../../Docs/Meridian-Complete-Documentation.md#6-memory-system-in-depth)

## Overview

Meridian's memory system is the product's core differentiator — a continuously evolving, structured knowledge base built automatically from everything the user touches. Unlike a chatbot that resets context every session, Meridian's memory compounds over time, making every agent smarter the longer it's used.
