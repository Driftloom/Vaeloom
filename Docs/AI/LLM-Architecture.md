...
Meridian uses **multi-model orchestration** — different agents route to the model best suited to their task — rather than a single hardcoded model.
...
- [`/Docs/Meridian-Complete-Documentation.md#44-ai-layer`](../../Docs/Meridian-Complete-Documentation.md#44-ai-layer)
