...
| Agent Roster (v1 — 8 agents) | [`/Docs/01-Meridian-MVP-Spec.md#5-agent-roster-v1`](../../Docs/01-Meridian-MVP-Spec.md#5-agent-roster-v1) | ✅ Excellent |
| Agent Roster (full — 28 agents) | [`/Docs/Meridian-Complete-Documentation.md#52-full-roster`](../../Docs/Meridian-Complete-Documentation.md#52-full-roster) | ✅ Excellent |
| Memory & Knowledge Graph | [`/Docs/04-memory-knowledge-graph.md`](../../Docs/04-memory-knowledge-graph.md) | ✅ Excellent |
| Memory System (in depth) | [`/Docs/Meridian-Complete-Documentation.md#6-memory-system-in-depth`](../../Docs/Meridian-Complete-Documentation.md#6-memory-system-in-depth) | ✅ Excellent |
| Agentic RAG & Retrieval | [`/Docs/Meridian-Complete-Documentation.md#65-agentic-rag`](../../Docs/Meridian-Complete-Documentation.md#65-agentic-rag) | ✅ Good |
...
| Link to conceptual docs as primary references, implementation as secondary | Conceptual docs (`/Docs/Meridian-Complete-Documentation.md`) are more stable than implementation files — readers should start with the "what" before the "how" |
...
| Specialist Agents | Execute domain-specific tasks | `apps/agents/` | [Agent Roster](../../Docs/01-Meridian-MVP-Spec.md#5-agent-roster-v1) |
...
meridian ai models list
meridian ai model deploy --name meridian-llm-v2 --instance-type gpu-large

# Inference
meridian ai infer --model meridian-llm-v2 --prompt "Summarize this document"
```

```python
# Use the Meridian AI SDK
from meridian.ai import InferenceClient

client = InferenceClient(model="meridian-llm-v2")
...
```bash
# AI operations
meridian ai monitor --model meridian-llm-v2
meridian ai logs --model meridian-llm-v2 --level error --since 1h
```
