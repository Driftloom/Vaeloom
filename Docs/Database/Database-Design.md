...
> **Purpose:** Define the database architecture for Meridian
...
|----------|---------|---------|----------|
| DATABASE_URL | Primary database connection | postgresql://localhost:5432/meridian | Yes |
