...
const pool = new Pool({
  ...
  primary: { host: 'primary.db.meridian.dev' },
  // Reads go to replica
  replica: { host: 'replica.db.meridian.dev' }
});
...
const replicaPool = new Pool({
  host: 'replica-1.db.meridian.dev',
  max: 30,
});
