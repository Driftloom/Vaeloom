...
| --------- | --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------- | --------------- | ---------- |
| CF-P06-01 | Prompt §3 lists NestJS + `apps/core-api` + `apps/ai-service` | All documentation now correctly references apps/api (FastAPI). Verified: 0 NestJS, 0 apps/api, 0 apps/ai-service, 0 apps/core-api references remain in docs/ | RESOLVED | REPO > prompt | 2026-08-15 |
