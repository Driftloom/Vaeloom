...
class DriveAgent(BaseAgent):
    ...
    tools = [
        ...
        Tool(name="create_google_doc", description="Create a new Google Document"),
        Tool(name="read_google_doc", description="Read content of a Google Document"),
        Tool(name="append_google_doc", description="Append text to a Google Document"),
        Tool(name="replace_google_doc_text", description="Replace text in a Google Document"),
