...
CANONICAL_CAPABILITIES: list[AgentCapabilityManifest] = [
    ...
    # 30. Company & Industry Research
    AgentCapabilityManifest(
        capability_id="workspace.research.company",
        agent_id="research",
        display_name="Company & Industry Intelligence Research",
        description="Conduct in-depth research on target companies, industry trends, tech stacks, leadership, and funding.",
        semantic_exemplars=[
            "research company industry",
            "look up tech stack and funding for openai",
            "market research on fintech trends",
            "company research and industry landscape",
            "research competitors in the ai career space",
        ],
        required_tools=["search_documents"],
        optional_tools=["web_search", "query_graph"],
        supported_memory_scopes=["research", "companies"],
        risk_class=RiskClass.LOW,
        default_autonomy=AutonomyLevel.READ,
        requires_approval_above=AutonomyLevel.READ,
        tier_requirement="mvp",
    ),
    # 31. Time & Meeting Scheduling
    AgentCapabilityManifest(
        capability_id="workspace.schedule.manage",
        agent_id="scheduler",
        display_name="Time Allocation & Study Scheduling",
        description="Plan recurring job search schedules, focus time blocks, and study routines.",
        semantic_exemplars=[
            "schedule a meeting",
            "schedule time to work on applications",
            "set up a study schedule for my week",
            "allocate time blocks for career planning",
            "schedule daily application hours",
        ],
        required_tools=["list_calendar_events"],
        optional_tools=["create_calendar_event"],
        supported_memory_scopes=["calendar", "timeline"],
        risk_class=RiskClass.MEDIUM,
        default_autonomy=AutonomyLevel.SUGGEST,
        requires_approval_above=AutonomyLevel.SUGGEST,
    ...
    AgentCapabilityManifest(
        capability_id="workspace.reminder.manage",
        agent_id="reminder",
        display_name="Deadline Alerts & Follow-up Reminders",
        description="Create, track, and dispatch deadline reminders, follow-up alerts, and priority tasks.",
        semantic_exemplars=[
            "set a reminder for my application deadline",
            "remind me tomorrow morning",
            "remind me to follow up with the recruiter",
            "create a deadline reminder",
            "remind me about the interview tomorrow",
        ],
        required_tools=["notify_user"],
        optional_tools=[],
        supported_memory_scopes=["reminders", "timeline"],
        risk_class=RiskClass.LOW,
        default_autonomy=AutonomyLevel.WRITE,
        requires_approval_above=AutonomyLevel.WRITE,
        tier_requirement="mvp",
    ),
    # 33. Career Reflection & Retrospective
    AgentCapabilityManifest(
        capability_id="workspace.reflection.retrospective",
        agent_id="reflection",
        display_name="Career Reflection & Weekly Retrospective",
        description="Conduct weekly and monthly career progress reflections, identify patterns, and celebrate milestones.",
        semantic_exemplars=[
            "weekly summary and reflection",
            "reflect on my weekly progress",
            "monthly career retrospective",
            "summarize my accomplishments this week",
            "weekly reflection on my applications",
        ],
        required_tools=["search_documents"],
        optional_tools=["query_graph"],
        supported_memory_scopes=["reflection", "career"],
        risk_class=RiskClass.LOW,
        default_autonomy=AutonomyLevel.READ,
        requires_approval_above=AutonomyLevel.READ,
        tier_requirement="mvp",
    ),
    # 34. Meta Self-Improvement & Benchmarking
    AgentCapabilityManifest(
        capability_id="workspace.meta.self_improvement",
        agent_id="self_improvement",
        display_name="Meta Self-Improvement & Benchmark Tuning",
        description="Evaluate agent output quality, audit accuracy against benchmark rubrics, and tune prompt guidelines.",
        semantic_exemplars=[
            "critique agent accuracy and response quality",
            "benchmark evaluation scores",
            "improve system prompt performance",
            "review model decision benchmarks",
        ],
        required_tools=[],
        optional_tools=["search_documents"],
        supported_memory_scopes=["meta_eval"],
        risk_class=RiskClass.LOW,
        default_autonomy=AutonomyLevel.READ,
        requires_approval_above=AutonomyLevel.READ,
        tier_requirement="enterprise",
