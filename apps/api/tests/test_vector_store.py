...
class TestVectorStore:
    async def test_fallback_store(self):
        from api.infrastructure.vector_store import FallbackVectorStore
    ...
    async def test_get_vector_store_default(self):
        ...
        with patch.dict("os.environ", {"VECTOR_STORE": "pgvector"}):
            ...
            from api.infrastructure.vector_store import PGVectorStore
    ...
    async def test_get_vector_store_qdrant_not_installed(self):
        ...
        with patch.dict("os.environ", {"VECTOR_STORE": "qdrant"}):
            with patch("api.infrastructure.vector_store.QdrantStore") as mock_qdrant:
                import builtins
    ...
    async def test_pgvector_upsert_search(self):
        from api.infrastructure.vector_store import PGVectorStore, VectorRecord
    ...
    async def test_vector_record_dataclass(self):
        from api.infrastructure.vector_store import VectorRecord
