...
class TestBullMQWorkerExtended:
    ...
    async def test_handle_event_publish_agent_execute(self, monkeypatch):
        ...
        monkeypatch.setattr("api.orchestrator.router.handle", mock_handle)
        monkeypatch.setattr("api.orchestrator.router.UserRequest", lambda **kw: mock_request)
        from api.workers.queue_worker import handle_event_publish
    ...
    async def test_handle_subscription_create(self):
        from api.workers.queue_worker import handle_subscription_create
    ...
    async def test_run_worker_full_entry(self, monkeypatch):
        from api.workers.queue_worker import run_worker
        ...
        monkeypatch.setattr("api.workers.queue_worker.BullMQWorker", lambda **kw: mock_worker)
    ...
    def test_main_block_executes(self, monkeypatch):
        import api.workers.queue_worker as module
        import pathlib
