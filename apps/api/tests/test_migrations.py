...
EXPECTED_VERSIONS = {"0002_microservice_tables", "0003_approvals", "0004_memory_taxonomy", "0005_rls", "0006_idempotency", "0007_gmail_watch", "0008_document_content", "0009_feature_flags"}
...
class TestMigrationRunner:
    ...
    async def test_downgrade_partial(self, migration_engine):
        ...
        assert set(rolled_back) == {"0009_feature_flags", "0008_document_content", "0007_gmail_watch", "0006_idempotency", "0005_rls"}
