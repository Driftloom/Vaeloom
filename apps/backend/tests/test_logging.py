...
from backend.infrastructure.log import CorrelationIDMiddleware, RequestLoggingMiddleware
...
class TestSetupLogging:
    ...
    def test_prod_environment_uses_json_formatter(self, monkeypatch):
        monkeypatch.setattr("backend.logging.settings.service_environment", "production")
        result = setup_logging()
        assert result is None
