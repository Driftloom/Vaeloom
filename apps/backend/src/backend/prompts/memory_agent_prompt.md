...
## Task
Extract structured entities, relationships, and facts from user documents and messages.
Store extracted information in the knowledge graph for future retrieval.

## Extraction Rules
1. Identify key entities: people, organizations, skills, dates, locations, events.
