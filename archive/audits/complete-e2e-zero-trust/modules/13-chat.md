...
- Event types: intent, supervisor_start, plan, act, qa, approval_required, done,
  error
- Conversation history management
- Agent routing based on intent
- Tool calling and citations
- Prompt injection middleware (PromptInjectionMiddleware)
- QA agent validates output safety
