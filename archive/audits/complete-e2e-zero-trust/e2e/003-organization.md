# E2E Scenario: 003-organization.md

## Scenario Description and Goal

Upload messy files → organization agent proposes renames/moves → user rejects
one → approves another → verify filesystem + DB + audit + memory
